...
SUDO = SUDO
sudo_users = {SUDO,332717942,332717942}   
print([[
> CH › @D03DD
> CH › @D03DD
~> DEVELOPER › @XXUUU
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/D03DD/Files_Tyler/main/File_Bot/commands.lua") 
...
if hash or SudoBot(msg) or DevTylerW(msg) or Sudo(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevTylerW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevTylerW(msg) or Sudo(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevTylerW(msg) or Sudo(msg) or BasicConstructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevTylerW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevTylerW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevTylerW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
local Tyler_Msg = ''  
if msgs < 100 then 
Tyler_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
Tyler_Msg = 'بدا يتحسن' 
elseif msgs < 400 then 
Tyler_Msg = 'باقي لك شوي' 
elseif msgs < 700 then 
Tyler_Msg = 'متفاعل' 
elseif msgs < 1200 then 
Tyler_Msg = 'متفاعل بقوه' 
elseif msgs < 2000 then 
Tyler_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
Tyler_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
Tyler_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
Tyler_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
Tyler_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
Tyler_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
Tyler_Msg = 'امبروطور التفاعل' 
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"@XXUUU")  
...
--------------------------------------------------------------------------------------------------------------
function SourceTyler(msg,data) -- بداية العمل امـيـر الـ دلـيـم
if msg then
...
local list = database:smembers(bot_id.."Tyler1:List:Filter"..sl)
...
if not DevTylerW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevTylerW(msg) and msg.reply_to_message_id_ ~= 0  then
...
send(msg.chat_id_, msg.id_,Tyler_Msg) 
return false  
end 
if text then
...
if text == 'تفعيل التواصل ✬' and DevTylerW(msg) then  
...
if text == 'تعطيل التواصل ✬' and DevTylerW(msg) then  
...
if text == 'تفعيل البوت الخدمي ✬' and DevTylerW(msg) then  
...
if text == 'تعطيل البوت الخدمي ✬' and DevTylerW(msg) then  
...
if text == 'ضع كليشه ستارت ✬' and DevTylerW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *✬︙ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ✬' and DevTylerW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *✬︙تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ✬' and DevTylerW(msg) then 
...
if text == 'المشتركين ✬' and DevTylerW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *✬︙المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'القروبات ✬' and DevTylerW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *✬︙القروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ✬") and DevTylerW(msg) then
...
if text == ("قائمه العام ✬") and DevTylerW(msg) then
...
if text == ("قائمه الكتم العام ✬") and DevTylerW(msg) then
...
if text=="اذاعه خاص ✬" and msg.reply_to_message_id_ == 0 and DevTylerW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✬︙ارسل الان اذاعتك؟* \n*✬︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ✬" and msg.reply_to_message_id_ == 0 and DevTylerW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✬︙ارسل الان اذاعتك؟* \n*✬︙للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ✬" and msg.reply_to_message_id_ == 0 and DevTylerW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✬︙ارسل الان اذاعتك؟* \n*✬︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ✬" and msg.reply_to_message_id_ == 0  and DevTylerW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✬︙ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ✬" and msg.reply_to_message_id_ == 0  and DevTylerW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ✬︙ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ✬' and DevTylerW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ✬" and DevTylerW(msg) then
...
if text == "تنظيف القروبات ✬" and DevTylerW(msg) then 
...
send(msg.chat_id_, msg.id_,'*✬︙عدد القروبات الان » { '..#group..' }'..Tylerk..''..Tyler..'*\n*✬︙الان عدد القروبات الحقيقي » { '..sendok..' } كروبات*\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevTylerW(msg) then
...
usertext = '*\n ✬︙اسم المستخدم »* ['..result.title_..'](t.me/'..(username or 'D03DD')..')'
status  = '\n *✬︙تم ترقيته مطور*'
...
if text and text:match("^رفع مطور (%d+)$") and DevTylerW(msg) then
...
if text and text:match("^تنزيل مطور @(.*)$") and DevTylerW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevTylerW(msg) then
...
local Tyler1_Msg = database:get(bot_id.."Tyler1:Add:Filter:Rp2"..text..msg.chat_id_)   
if Tyler1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *✬︙اسم المستخدم »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'D03DD')..') \n ✬︙'..Tyler1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if Tyler_Msg and not Special(msg) then  
local Tyler_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if Tyler_Msg then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *✬︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n✬︙["..Tyler_Msg.."] \n")
else
send(msg.chat_id_,0," *✬︙العضو :* {["..data.first_name_.."](T.ME/D03DD)}\n✬︙["..Tyler_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
...
send(msg.chat_id_,0, " *✬︙عذرا ↫* {["..data.first_name_.."](T.ME/D03DD)}\n*✬︙عذرا تم منع الملصق* \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevTylerW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevTylerW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevTylerW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *✬︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevTylerW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *✬︙حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ✬" and DevTylerW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *✬︙تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ✬$") and DevTylerW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *✬︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ✬" and DevTylerW(msg) then  
...
if text == "تعطيل الاشتراك الاجباري ✬" and DevTylerW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *✬︙تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ✬" and DevTylerW(msg) then  
if database:get(bot_id..'add:ch:username') then
local addchusername = database:get(bot_id..'add:ch:username')
...
database:sadd(bot_id.."Tyler:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."Tyler:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_Tyler = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_Tyler then 
names_Tyler = database:smembers(bot_id.."Tyler:blocname"..msg.chat_id_) or ""
if names_Tyler and names_Tyler[1] then 
for i=1,#names_Tyler do 
if name_Tyler:match("(.*)("..names_Tyler[i]..")(.*)") then 
...
database:set(bot_id.."Tyler:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."Tyler:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."Tyler:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."Tyler:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."Tyler:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_Tylera_new(Tyler1,Tyler2)
if Tyler2 and Tyler2.first_name_ then 
if Tyler2.first_name_:match("(.*)"..database:get(bot_id.."Tyler:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."Tyler:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local Tyler_nnn = database:get(bot_id.."Tyler:nump"..msg.chat_id_) or 5
local Tyler_nnn2 = database:get(bot_id.."Tyler:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(Tyler_nnn2) == tonumber(Tyler_nnn) or tonumber(Tyler_nnn2) > tonumber(Tyler_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."Tyler:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "✬︙عزيزي >>["..Tyler2.username_.."](https://t.me/"..(Tyler2.username_ or "D03DD")..")\n✬︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."Tyler:teh"..msg.chat_id_).."} بجانب اسمك\n✬︙عدد المحاولات المتبقيه {"..(tonumber(Tyler_nnn) - tonumber(Tyler_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_Tylera_new)
end
end
...
local TylerChengName = database:get(bot_id.."Tyler:Cheng:Name"..data.id_)
if not data.first_name_ then 
if TylerChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..TylerChengName..']')
database:del(bot_id.."Tyler:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if TylerChengName ~= data.first_name_ then 
local Text = {
  "كان اسمك حلوو ليه غيرته",
"ليش غيرت اسمك لايكون خانوك/ش",
"هذا الحلو غير اسمه 😉",
}
send(msg.chat_id_, msg.id_,Text[math.random(#Text)])
end  
database:set(bot_id.."Tyler:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local TylerChengUserName = database:get(bot_id.."Tyler:Cheng:UserName"..data.id_)
if not data.username_ then 
if TylerChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه اسرقوه بسرعه بسرعه  \n هذا معرفه  : [@"..TylerChengUserName..']')
database:del(bot_id.."Tyler:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if TylerChengUserName ~= data.username_ then 
local Text = {
'ليه غيرت معرفك لايكون نشروه في قنوات فضايح',
"هههههههههه ليه غيرت معرفك لايكون هددك حبيبك",
"ايش حصل معك لما غيرت معرفك قلي ايش سرك😐🌝",
"غير معرفه خذوه بسرعه بسرعه \n هذه معرفه : @"..data.username_.."",
'ها ايش سويت من جريمه \n ايش غيرته ل @'..data.username_..' ',
'ها شكلك اشتريت معرف جديد بكم اخذته', 
"منور بمعرفك الجديد :  "..data.username_.."",
}
send(msg.chat_id_, msg.id_,Text[math.random(#Text)])
end  
database:set(bot_id.."Tyler:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local TylerChengPhoto = database:get(bot_id.."Tyler:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if TylerChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور الحلو غبي وربي 😂🥺")
database:del(bot_id.."Tyler:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if TylerChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
  "ليه غيرت صورتك من اي برايفل اخذتها",
  "منور طالع حلو في الصوره الجديده",
  "ي ولد غيرت صورتك مين قال لك انها مو حلوه😍😂",
  "هاااه غيرت صورتك قلي من فين سرقت الجديده😹😹🌚",
  "ليه غيرت صورتك لايكون تهاوشت مع الحب؟😹🌞",
  "ليه غيرت الصوره ايش الموضوع؟🤔🌞",
}
send(msg.chat_id_, msg.id_,Text[math.random(#Text)])
end  
database:set(bot_id.."Tyler:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
if text == 'رفع نسخه الاحتياطيه' and DevTylerW(msg) then  
if tonumber(msg.reply_to_message_id_) > 0 then
...
send(msg.chat_id_, msg.id_, '*✬︙بواسطه* » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'D03DD')..') \n*✬︙تم تفعيل التنظيف التلقائي* ')
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *✬︙بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'D03DD')..') \n*✬︙تـم قفـل التاك بالكتم* ')
end,nil)   
...
if text == ("مسح قائمه العام") and DevTylerW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevTylerW(msg) then  
function start_function(extra, result, success)
if TylerSudoBot(result.sender_user_id_) then
...
if text and text:match("^حظر عام @(.*)$")  and DevTylerW(msg) then  
...
if TylerSudoBot(result.id_) then
send(msg.chat_id_, msg.id_,"*✬︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text and text:match("^حظر عام (%d+)$") and DevTylerW(msg) then  
local userid = text:match("^حظر عام (%d+)$")
if TylerSudoBot(userid) then
send(msg.chat_id_, msg.id_,"*✬︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevTylerW(msg) then  
function start_function(extra, result, success)
if TylerSudoBot(result.sender_user_id_) then
send(msg.chat_id_, msg.id_,"*✬︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
...
if text and text:match("^كتم عام @(.*)$")  and DevTylerW(msg) then  
...
if text and text:match("^كتم عام (%d+)$") and DevTylerW(msg) then  
local userid = text:match("^كتم عام (%d+)$")
if TylerSudoBot(bot_id) then
send(msg.chat_id_, msg.id_,"*✬︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
if tonumber(userid) == tonumber(bot_id) then  
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevTylerW(msg) then  
function start_function(extra, result, success)
...
if text and text:match("^الغاء العام @(.*)$") and DevTylerW(msg) then  
...
if text and text:match("^الغاء العام (%d+)$") and DevTylerW(msg) then  
...
if text == 'الملفات' and DevTylerW(msg) then
t = ' *✬︙ملفات السورس تايلر ↓*\n*•━━━━━━  ━━━━━━━•* \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
if DevTylerW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/DMMARC/Files_Tyler/main/getfile.json")
if res == 200 then
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevTylerW(msg) then
...
send(msg.chat_id_, msg.id_," *✬︙عذرا الملف لايدعم سورس تايلر* \n") 
end
return false
end
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevTylerW(msg) then
...
if text == "مسح الملفات" and DevTylerW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," *✬︙تم مسح الملفات*")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevTylerW(msg) then  
function start_function(extra, result, success)
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevTylerW(msg) then  
function start_function(extra, result, success)
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *✬︙لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'D03DD')..')'
status  = '\n*✬︙تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *✬︙اسم المستخدم »* '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *✬︙اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'D03DD')..')'
local  statuss  = '\n*✬︙تم رفع العضو حمار في القروب* \n*✬︙ركبنالك عربه من بكره تبدا الشغل*'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *✬︙اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'D03DD')..')'
status  = '\n*✬︙تم تنزيل العضو حمار في القروب*\n*✬︙خلاص عجزت مامنك فايده رجع العربه*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
-----------------------------------------------------
if text == 'تنزيل المزز' and Mod(msg) then
...
---------
if text == ("رفع مزه") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) and GetChannelMember(msg) then  
if database:get(bot_id..'Lock:Add:Bot'..msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_, msg.id_,' *✬︙تم تعطيل الرفع*') 
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *✬︙العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'D03DD')..')'
local  statuss  = '\n*✬︙تم رفع العضــو مزه في القروب* \n*✬︙يلا نهرب ي احلا مزه في القروب*'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if (text == ("تنزيل مزه")) and msg.reply_to_message_id_ and Mod(msg) and GetChannelMember(msg) then  
function start_function(extra, result, success)
database:srem(bot_id..'Mode:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *✬︙العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'D03DD')..')'
status  = '\n*✬︙تم تنزيلها من مزز القروب*\n*✬︙قدك شوعه خلاص امسحي رقمي*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
------------------------------------------------------------------------ سونيك
if text == 'تنزيل المطانيخ' and Mod(msg) then
database:del(bot_id..'Sakl:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' *✬︙تم تنزيل جميع المطانيخ من القروب*')
end
if text == ("تاك للمطانيخ") and Mod(msg) then
local list = database:smembers(bot_id..'Sakl:User'..msg.chat_id_)
t = "\n *✬︙قائمة للمطانيخ القروب* \n*•━━━━━━  ━━━━━━━•*\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."» *المطنوخ* [@"..username.."]\n"
else
t = t..""..k.."» *المطنوخ* `"..v.."`\n"
end
end
...
---------
if text == ("رفع مطنوخ") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) and GetChannelMember(msg) then  
if database:get(bot_id..'Lock:Add:Bot'..msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_, msg.id_,' *✬︙تم تعطيل الرفع*') 
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *✬︙اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'D03DD')..')'
local  statuss  = '\n*✬︙تم رفع العضو مطنوخ بالقروب*\n*✬︙حيا الله مطنوخ القروب ارحب ملايين*'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if (text == ("تنزيل مطنوخ")) and msg.reply_to_message_id_ and Mod(msg) and GetChannelMember(msg) then  
function start_function(extra, result, success)
database:srem(bot_id..'Sakl:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *✬︙اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'D03DD')..')'
status  = '\n*✬︙تم تنزيل العضو من المطانيخ*\n*✬︙ارجع بيتكم خلاص خلصت فلوسك *'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' *✬︙تم تنزيل جميع البقر بالقروب*')
end
...
------------------------------------------------------------------------ سونيك
if text == 'تنزيل الخرفان' and Mod(msg) then
database:del(bot_id..'Tele:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' *✬︙تم تنزيل جميع الخرفان بالقروب')
end
if text == ("تاك للخرفان") and Mod(msg) then
local list = database:smembers(bot_id..'Tele:User'..msg.chat_id_)
t = "\n *✬︙قائمة الخرفان القروب* \n*•━━━━━━  ━━━━━━━•*\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
---------
if text == ("رفع خروف") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) and GetChannelMember(msg) then  
if database:get(bot_id..'Lock:Add:Bot'..msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_, msg.id_,' *✬︙تم تعطيل الرفع*') 
return false
end
...
if (text == ("تنزيل خروف")) and msg.reply_to_message_id_ and Mod(msg) and GetChannelMember(msg) then  
function start_function(extra, result, success)
database:srem(bot_id..'Tele:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *✬︙اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'D03DD')..')'
status  = '\n*✬︙تم تنزيل الخروف من القروب*\n *✬︙يلا مسامح لاتصير خروف مره ثانيه*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
------------------------------------------------------------------------ سونيك
if text == 'تنزيل الفيران' and Mod(msg) then
database:del(bot_id..'Jred:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' *✬︙تم تنزيل جميع الفيران*')
end
if text == ("تاك للفيران") and Mod(msg) then
local list = database:smembers(bot_id..'Jred:User'..msg.chat_id_)
t = "\n *✬︙قائمة فيران القروب* \n*•━━━━━━  ━━━━━━━•*\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."» *الفار* [@"..username.."]\n"
else
t = t..""..k.."» *الفار* "..v.."\n"
end
end
...
---------
if text == ("رفع فار") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) and GetChannelMember(msg) then  
if database:get(bot_id..'Lock:Add:Bot'..msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_, msg.id_,' *✬︙تم تعطيل الرفع*') 
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *✬︙اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'D03DD')..')'
local  statuss  = '\n*✬︙تم رفع فار في القروب*\n*✬︙خايسه الريحه الطالعه منك روح تسبح*'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if (text == ("تنزيل فار")) and msg.reply_to_message_id_ and Mod(msg) and GetChannelMember(msg) then  
function start_function(extra, result, success)
database:srem(bot_id..'Jred:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *✬︙اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'D03DD')..')'
status  = '\n*✬︙تم تنزيل فار من القروب*\n*✬︙خذ الصابونه تسبح دايما لاتفضحنا*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if text == ("تقييد") and msg.reply_to_message_id_ and Mod(msg) and GetChannelMember(msg) then  
function start_function(extra, result, success)
if TylerSudoBot(result.sender_user_id_) then
send(msg.chat_id_, msg.id_,"*✬︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
...
if text and text:match("^تقييد @(.*)$") and Mod(msg) and GetChannelMember(msg) then  
...
------------------------------------------------------------------------
if text and text:match("^تقييد (%d+)$") and Mod(msg) and GetChannelMember(msg) then  
...
------------------------------------------------------------------------
if text == ("الغاء تقييد") and msg.reply_to_message_id_ and Mod(msg) and GetChannelMember(msg) then  
function start_function(extra, result, success)
...
------------------------------------------------------------------------
if text and text:match("^الغاء تقييد @(.*)$") and Mod(msg) and GetChannelMember(msg) then  
...
------------------------------------------------------------------------
if text and text:match("^الغاء تقييد (%d+)$") and Mod(msg) and GetChannelMember(msg) then  
...
database:set(bot_id.."Tyler1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."Tyler1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," *✬︙ارسل التحذير عند ارسال الكلمه*")  
database:set(bot_id.."Tyler1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."Tyler1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."Tyler1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."Tyler1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," *✬︙تم منع الكلمه مع التحذير*")  
database:del(bot_id.."Tyler1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."Tyler1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."Tyler1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."Tyler1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," *✬︙ارسل الكلمه الان*")  
database:set(bot_id.."Tyler1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."Tyler1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."Tyler1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Tyler1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."Tyler1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."Tyler1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."Tyler1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Tyler1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."Tyler1:List:Filter"..msg.chat_id_,v)  
end  
...
if text == 'مسح كليشه المطور' and DevTylerW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *✬︙تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DevTylerW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *✬︙اسم المستخدم »* ['..result.title_..'](t.me/'..(text1[3] or 'D03DD')..')'..'\n*✬︙تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevTylerW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevTylerW(msg) then  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'تايلر').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'تايلر')
local Tyler_Msg = {
'اشتبي؟ 🥺💕.',
'هاا ☹️.',
'اول مره تشوف بوت 😂.',
'عيون وقلب '..Namebot..'💖',
'مشغول حالياً',
'اشغلتنا '..Namebot..'خير تكلم '
}
send(msg.chat_id_, msg.id_,'['..Tyler_Msg[math.random(#Tyler_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevTylerW(msg) then 
...
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = 200},function(ta,Tyler)
local t = "\n*ツ قائمة الاعضاء* \n*•━━━━━━  ━━━━━━━•*\n"
x = 0
local list = Tyler.members_
for k, v in pairs(list) do
x = x + 1
...
if TylerSudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevTylerW(msg) then 
...
if text == ("ردود المطور") and DevTylerW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ✬︙قائمة ردود المطور \n*•━━━━━━  ━━━━━━━•*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevTylerW(msg) then    
send(msg.chat_id_, msg.id_,' *✬︙ارسل الكلمه تريد اضافتها*')
database:set(bot_id..'Set:Rd'..msg.sender_user_id_..':'..msg.chat_id_,true)
return false 
end
if text == 'حذف رد للكل' and DevTylerW(msg) then    
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'تايلر').." غادر" or text == 'غادر' then  
...
if text == 'تفعيل المغادره' and DevTylerW(msg) then   
...
if text == 'تعطيل المغادره' and DevTylerW(msg) then  
...
-- vardump(data) 
Tylerdx(msg.chat_id_, msg.id_, ' *✬︙ايدي المجموعة » ( '..msg.chat_id_..' )*\n*✬︙عدد الادمنيه » ( '..data.administrator_count_..' )*\n*✬︙عدد المحظورين » ( '..data.kicked_count_..' )*\n*✬︙عدد الاعضاء » ( '..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevTylerW(msg) then
...
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(" *✬︙عذرا لا استطيع طرد ادمنية القروب*")..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'تايلر')
...
Tyler = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(Tyler)
...
--------------------------------------------------------------------------------------------------------------
SourceTyler(data.message_,data)
...
------------------------------------------------------------------------
local TylerAbot = database:get(bot_id.."Tyler1:Add:Filter:Rp2"..text..result.chat_id_)   
if TylerAbot then
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *✬︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n✬︙["..TylerAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local Tyler1_Msg = database:get(bot_id.."Tyler1:Add:Filter:Rp2"..text..result.chat_id_)   
if Tyler1_Msg then
send(msg.chat_id_, msg.id_," ✬︙"..Tyler1_Msg)
