...
Id_Sudo = Sudo
List_Sudos = {Id_Sudo,1890819157,0000000,332717942}
...
io.popen("mkdir Tyler_Files")
t = "\27[35m".."\nAll Files Started : \n____________________\n"..'\27[m'
i = 0
for v in io.popen('ls Tyler_Files'):lines() do
if v:match(".lua$") then
i = i + 1
...
function DevBot(msg) 
local hash = database:sismember(bot_id.."Tyler:Sudo:User", msg.sender_user_id_) 
if hash or Bot(msg) or DevTyler(msg) or VIP_DeV(msg) then    
return true  
else  
return false  
end  
...
if hash or DevBot(msg) or DevTyler(msg) or VIP_DeV(msg) then    
return true 
else 
return false 
end 
...
local hash = database:sismember(bot_id.."Tyler:Basic:Constructor"..msg.chat_id_, msg.sender_user_id_) 
if hash or Bot(msg) or DevTyler(msg) or DevBot(msg) or VIP_DeV(msg) or creatorA(msg) then     
return true 
else 
return false 
end 
...
local hash = database:sismember(bot_id.."Tyler:Constructor"..msg.chat_id_, msg.sender_user_id_) 
if hash or Bot(msg) or DevTyler(msg) or DevBot(msg) or BasicConstructor(msg) or VIP_DeV(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
function Owner(msg)
local hash = database:sismember(bot_id.."Tyler:Manager"..msg.chat_id_,msg.sender_user_id_)    
if hash or Bot(msg) or DevTyler(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or VIP_DeV(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
local hash = database:sismember(bot_id.."Tyler:Mod:User"..msg.chat_id_,msg.sender_user_id_)    
if hash or Bot(msg) or DevTyler(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or VIP_DeV(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
function Vips(msg)
local hash = database:sismember(bot_id.."Tyler:Special:User"..msg.chat_id_,msg.sender_user_id_) 
if hash or Bot(msg) or  DevTyler(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or Addictive(msg) or VIP_DeV(msg) or creatorA(msg) then             
return true 
else 
return false 
end 
...
local z = io.open('./Tyler')
local AllGroups = z:read('*all')
z:close()
if not AllGroups:match("^(.*)(main/Tyler.lua)(.*)$") then
os.execute('chmod +x install.sh')
os.execute('./install.sh get')
end
end
function General_ban(user_id,chat_id)
if DevTyler(user_id) == true then  
var = true  
elseif tonumber(user_id) == tonumber(bot_id) then  
var = true  
elseif database:sismember(bot_id.."DEV:Sudo:T", user_id) then
var = true  
elseif database:sismember(bot_id.."Tyler:Sudo:User", user_id) then
var = true  
else  
var = false  
end  
...
if tonumber(user_id) == tonumber(1890819157) then  
var = true  
elseif tonumber(user_id) == tonumber(332717942) then
var = true  
elseif tonumber(user_id) == tonumber(0000000) then
var = true  
...
var = true                
elseif database:sismember(bot_id.."Tyler:Basic:Constructor"..chat_id, user_id) then
var = true
elseif database:sismember(bot_id.."Tyler:Constructor"..chat_id, user_id) then
var = true  
elseif database:sismember(bot_id.."Tyler:Manager"..chat_id, user_id) then
var = true  
elseif database:sismember(bot_id.."Tyler:Mod:User"..chat_id, user_id) then
var = true  
elseif database:sismember(bot_id.."Tyler:Special:User"..chat_id, user_id) then  
var = true  
else  
var = false  
end  
...
if tonumber(user_id) == tonumber(332717942) then  
var = "مطور السورس"  
elseif tonumber(user_id) == tonumber(1890819157) then  
var = 'مبــرمج السـورس'
elseif DevTyler(user_id) == true then
var = "المطور الاساسي"  
elseif tonumber(user_id) == tonumber(bot_id) then  
var = "البوت"
elseif database:sismember(bot_id.."DEV:Sudo:T", user_id) then  var = "المطور الاساسي²"  
elseif database:sismember(bot_id.."Tyler:Sudo:User", user_id) then
var = database:get(bot_id.."Tyler:Sudo:Rd"..chat_id) or "المطور"  
elseif database:sismember(bot_id.."creator"..chat_id,user_id) then var = "المالك"
elseif database:sismember(bot_id.."Tyler:Basic:Constructor"..chat_id, user_id) then
var = database:get(bot_id.."Tyler:BasicConstructor:Rd"..chat_id) or "المنشئ اساسي"
elseif database:sismember(bot_id.."Tyler:Constructor"..chat_id, user_id) then
var = database:get(bot_id.."Tyler:Constructor:Rd"..chat_id) or "المنشئ"  
elseif database:sismember(bot_id.."Tyler:Manager"..chat_id, user_id) then
var = database:get(bot_id.."Tyler:Manager:Rd"..chat_id) or "المدير"  
elseif database:sismember(bot_id.."Tyler:Mod:User"..chat_id, user_id) then
var = database:get(bot_id.."Tyler:Mod:Rd"..chat_id) or "الادمن"  
elseif database:sismember(bot_id.."Tyler:Special:User"..chat_id, user_id) then  
var = database:get(bot_id.."Tyler:Special:Rd"..chat_id) or "المميز"  
else  
var = database:get(bot_id.."Tyler:Memp:Rd"..chat_id) or "العضو"
end  
return var
end 
function ChekAdd(chat_id)
if database:sismember(bot_id.."Tyler:Chek:Groups",chat_id) then
var = true
else 
var = false
end
...
if database:sismember(bot_id.."Tyler:Muted:User"..Chat_id,User_id) then
Var = true
else
Var = false
end
...
if database:sismember(bot_id.."Tyler:Ban:User"..Chat_id,User_id) then
Var = true
else
Var = false
end
...
if database:sismember(bot_id.."Tyler:MuAn:User",User_id) then
Var = true
else
Var = false
end
...
if database:sismember(bot_id.."Tyler:GBan:User",User_id) then
Var = true
else
Var = false
end
...
local UserName = (data.username_ or "D03DD")
...
database:sadd(bot_id..'Tyler:Chek:Groups',idg) 
database:set(bot_id.."Tyler:Lock:tagservrbot"..idg,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:set(bot_id..'Tyler:'..lock..idg,"del")    
end
if v.creator then
...
database:sadd(bot_id.."Tyler:Constructor"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
database:sadd(bot_id.."Tyler:Manager"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
database:sadd(bot_id.."Tyler:Mod:User"..idg,idmod)  
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
database:sadd(bot_id.."Tyler:Basic:Constructor"..idg,idASAS)  
end;end
if v.linkgroup then
if v.linkgroup ~= "" then
database:set(bot_id.."Tyler:Private:Group:Link"..idg,v.linkgroup)   
end;end;end
...
database:sadd(bot_id.."Tyler:Muted:User"..msg.chat_id_,msg.sender_user_id_) 
...
function Tyler_Files(msg)
for v in io.popen('ls Tyler_Files'):lines() do
if v:match(".lua$") then
plugin = dofile("Tyler_Files/"..v)
if plugin.Tyler and msg then
pre_msg = plugin.Tyler(msg)
end
end
end
send(msg.chat_id_, msg.id_,pre_msg)  
end
function Tyler_Started_Bot(msg,data) -- بداية العمل
if msg then
...
database:incr(bot_id..'Tyler:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) 
Chat_Type = 'GroupBot' 
elseif id:match("^(%d+)") then
database:sadd(bot_id..'Tyler:UsersBot',msg.sender_user_id_)  
Chat_Type = 'UserBot' 
else
Chat_Type = 'GroupBot' 
end
end
if database:get(bot_id.."Tyler:Tyler:Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ⋄" then   
send(msg.chat_id_, msg.id_,"*⋄︙تم الغاء الاذاعه*") 
database:del(bot_id.."Tyler:Tyler:Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
local list = database:smembers(bot_id.."Tyler:Chek:Groups") 
if msg.content_.text_ then
for k,v in pairs(list) do 
send(v, 0,"["..msg.content_.text_.."]")  
database:set(bot_id..'Tyler:Msg:Pin:Chat'..v,msg.content_.text_) 
end
...
database:set(bot_id..'Tyler:Msg:Pin:Chat'..v,photo) 
end 
elseif msg.content_.animation_ then
for k,v in pairs(list) do 
sendDocument(v, 0, msg.content_.animation_.animation_.persistent_id_,(msg.content_.caption_ or "")) 
database:set(bot_id..'Tyler:Msg:Pin:Chat'..v,msg.content_.animation_.animation_.persistent_id_)
end 
elseif msg.content_.sticker_ then
for k,v in pairs(list) do 
sendSticker(v, 0, msg.content_.sticker_.sticker_.persistent_id_)   
database:set(bot_id..'Tyler:Msg:Pin:Chat'..v,msg.content_.sticker_.sticker_.persistent_id_) 
end 
end
...
if not Vips(msg) and msg.content_.ID ~= "MessageChatAddMembers" and database:hget(bot_id.."Tyler:flooding:settings:"..msg.chat_id_,"flood") then 
floods = database:hget(bot_id.."Tyler:flooding:settings:"..msg.chat_id_,"flood") or "nil"
Num_Msg_Max = database:hget(bot_id.."Tyler:flooding:settings:"..msg.chat_id_,"floodmax") or 5
Time_Spam = database:hget(bot_id.."Tyler:flooding:settings:"..msg.chat_id_,"floodtime") or 5
local post_count = tonumber(database:get(bot_id.."Tyler:floodc:"..msg.sender_user_id_..":"..msg.chat_id_) or 0)
if post_count > tonumber(database:hget(bot_id.."Tyler:flooding:settings:"..msg.chat_id_,"floodmax") or 5) then 
local ch = msg.chat_id_
local type = database:hget(bot_id.."Tyler:flooding:settings:"..msg.chat_id_,"flood") 
Is_Not_Spam(msg,type)  
end
database:setex(bot_id.."Tyler:floodc:"..msg.sender_user_id_..":"..msg.chat_id_, tonumber(database:hget(bot_id.."Tyler:flooding:settings:"..msg.chat_id_,"floodtime") or 3), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if database:hget(bot_id.."Tyler:flooding:settings:"..msg.chat_id_,"floodmax") then
Num_Msg_Max = database:hget(bot_id.."Tyler:flooding:settings:"..msg.chat_id_,"floodmax") 
end
if database:hget(bot_id.."Tyler:flooding:settings:"..msg.chat_id_,"floodtime") then
Time_Spam = database:hget(bot_id.."Tyler:flooding:settings:"..msg.chat_id_,"floodtime") 
end 
end 
--------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."Tyler:Lock:text"..msg.chat_id_) and not Vips(msg) then       
DeleteMessage(msg.chat_id_,{[0] = msg.id_})   
return false     
end     
--------------------------------------------------------------------------------------------------------------
if msg.content_.ID == "MessageChatAddMembers" then 
database:incr(bot_id.."Tyler:Add:Memp"..msg.chat_id_..":"..msg.sender_user_id_) 
end
if msg.content_.ID == "MessageChatAddMembers" and not Vips(msg) then   
if database:get(bot_id.."Tyler:Lock:AddMempar"..msg.chat_id_) == "kick" then
...
if database:get(bot_id.."Tyler:Lock:Join"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
return false  
end
end
...
if database:get(bot_id.."Tyler:Lock:User:Name"..msg.chat_id_) == "del" and not Vips(msg) then    
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tyler:Lock:User:Name"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tyler:Lock:User:Name"..msg.chat_id_) == "kick" and not Vips(msg) then    
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tyler:Lock:User:Name"..msg.chat_id_) == "ktm" and not Vips(msg) then    
database:sadd(bot_id.."Tyler:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if msg.content_.caption_ then 
if msg.content_.caption_:match("#[%a%d_]+") or msg.content_.caption_:match("#(.+)") then 
if database:get(bot_id.."Tyler:Lock:hashtak"..msg.chat_id_) == "del" and not Vips(msg) then    
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tyler:Lock:hashtak"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tyler:Lock:hashtak"..msg.chat_id_) == "kick" and not Vips(msg) then    
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tyler:Lock:hashtak"..msg.chat_id_) == "ktm" and not Vips(msg) then    
database:sadd(bot_id.."Tyler:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if msg.content_.caption_ then 
if msg.content_.caption_:match("/[%a%d_]+") or msg.content_.caption_:match("/(.+)") then  
if database:get(bot_id.."Tyler:Lock:Cmd"..msg.chat_id_) == "del" and not Vips(msg) then    
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tyler:Lock:Cmd"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tyler:Lock:Cmd"..msg.chat_id_) == "kick" and not Vips(msg) then    
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tyler:Lock:Cmd"..msg.chat_id_) == "ktm" and not Vips(msg) then    
database:sadd(bot_id.."Tyler:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."Tyler:Lock:Link"..msg.chat_id_) == "del" and not Vips(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tyler:Lock:Link"..msg.chat_id_) == "ked" and not Vips(msg) then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tyler:Lock:Link"..msg.chat_id_) == "kick" and not Vips(msg) then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tyler:Lock:Link"..msg.chat_id_) == "ktm" and not Vips(msg) then
database:sadd(bot_id.."Tyler:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."Tyler:Lock:Photo"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tyler:Lock:Photo"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tyler:Lock:Photo"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tyler:Lock:Photo"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Tyler:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."Tyler:Lock:Video"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tyler:Lock:Video"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tyler:Lock:Video"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tyler:Lock:Video"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Tyler:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."Tyler:Lock:Animation"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tyler:Lock:Animation"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tyler:Lock:Animation"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tyler:Lock:Animation"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Tyler:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."Tyler:Lock:geam"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tyler:Lock:geam"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tyler:Lock:geam"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tyler:Lock:geam"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Tyler:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."Tyler:Lock:Audio"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tyler:Lock:Audio"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tyler:Lock:Audio"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tyler:Lock:Audio"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Tyler:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."Tyler:Lock:vico"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tyler:Lock:vico"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tyler:Lock:vico"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tyler:Lock:vico"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Tyler:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."Tyler:Lock:Keyboard"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tyler:Lock:Keyboard"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tyler:Lock:Keyboard"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tyler:Lock:Keyboard"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Tyler:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."Tyler:Lock:Sticker"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tyler:Lock:Sticker"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tyler:Lock:Sticker"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tyler:Lock:Sticker"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Tyler:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."Tyler:Lock:forward"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif database:get(bot_id.."Tyler:Lock:forward"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif database:get(bot_id.."Tyler:Lock:forward"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif database:get(bot_id.."Tyler:Lock:forward"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Tyler:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
end
...
if database:get(bot_id.."Tyler:Lock:Document"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tyler:Lock:Document"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tyler:Lock:Document"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tyler:Lock:Document"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Tyler:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."Tyler:Lock:Unsupported"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tyler:Lock:Unsupported"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tyler:Lock:Unsupported"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tyler:Lock:Unsupported"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Tyler:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if not Vips(msg) then
if database:get(bot_id.."Tyler:Lock:Markdaun"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tyler:Lock:Markdaun"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tyler:Lock:Markdaun"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tyler:Lock:Markdaun"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Tyler:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end  
...
if database:get(bot_id.."Tyler:Lock:Inlen"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tyler:Lock:Inlen"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tyler:Lock:Inlen"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tyler:Lock:Inlen"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Tyler:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end 
...
if database:get(bot_id.."Tyler:Lock:Contact"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tyler:Lock:Contact"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tyler:Lock:Contact"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tyler:Lock:Contact"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Tyler:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
sens = 400  
if database:get(bot_id.."Tyler:Lock:Spam"..msg.chat_id_) == "del" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tyler:Lock:Spam"..msg.chat_id_) == "ked" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tyler:Lock:Spam"..msg.chat_id_) == "kick" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tyler:Lock:Spam"..msg.chat_id_) == "ktm" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
database:sadd(bot_id.."Tyler:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
--------------------------------------------------------------------------------------------------------------
local status_welcome = database:get(bot_id.."Tyler:Chek:Welcome"..msg.chat_id_)
if status_welcome and not database:get(bot_id.."Tyler:Lock:tagservr"..msg.chat_id_) then
if msg.content_.ID == "MessageChatJoinByLink" then
tdcli_function({ID = "GetUser",user_id_=msg.sender_user_id_},function(extra,result) 
local GetWelcomeGroup = database:get(bot_id.."Tyler:Get:Welcome:Group"..msg.chat_id_)  
...
database:set(bot_id.."Tyler:Pin:Id:Msg"..msg.chat_id_,msg.content_.message_id_)
else
local Msg_Pin = database:get(bot_id.."Tyler:Pin:Id:Msg"..msg.chat_id_)
if Msg_Pin and database:get(bot_id.."Tyler:lockpin"..msg.chat_id_) then
...
if database:get(bot_id.."Tyler:Change:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) then 
...
database:del(bot_id.."Tyler:Change:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) 
return false  end
...
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."Tyler:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if text == "الغاء" then 
send(msg.chat_id_, msg.id_,"*⋄︙تم الغاء وضع الوصف*") 
database:del(bot_id.."Tyler:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)
return false  
end 
database:del(bot_id.."Tyler:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
...
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."Tyler:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text == "الغاء" then 
send(msg.chat_id_, msg.id_,"*⋄︙تم الغاء حفظ الترحيب*") 
database:del(bot_id.."Tyler:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  
end 
database:del(bot_id.."Tyler:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
database:set(bot_id.."Tyler:Get:Welcome:Group"..msg.chat_id_,text) 
send(msg.chat_id_, msg.id_,"*⋄︙تم حفظ ترحيب المجموعه*")   
return false   
end
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."Tyler:Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) then
if text == "الغاء" then
send(msg.chat_id_,msg.id_,"*⋄︙تم الغاء حفظ الرابط*")       
database:del(bot_id.."Tyler:Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) 
return false
end
if text and text:match("(https://telegram.me/joinchat/%S+)") or text and text:match("(https://t.me/joinchat/%S+)") then     
local Link = text:match("(https://telegram.me/joinchat/%S+)") or text:match("(https://t.me/joinchat/%S+)")   
database:set(bot_id.."Tyler:Private:Group:Link"..msg.chat_id_,Link)
...
if database:get(bot_id.."Tyler:Tyler:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ⋄" then   
send(msg.chat_id_, msg.id_,"*⋄︙تم الغاء الاذاعه للخاص*") 
database:del(bot_id.."Tyler:Tyler:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
local list = database:smembers(bot_id..'Tyler:UsersBot')  
if msg.content_.text_ then
for k,v in pairs(list) do 
send(v, 0,"["..msg.content_.text_.."]")  
end
...
if database:get(bot_id.."Tyler:Tyler:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ⋄" then   
send(msg.chat_id_, msg.id_,"*⋄︙تم الغاء الاذاعه*") 
database:del(bot_id.."Tyler:Tyler:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
local list = database:smembers(bot_id.."Tyler:Chek:Groups") 
if msg.content_.text_ then
...
if database:get(bot_id.."Tyler:Tyler:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ⋄" then   
send(msg.chat_id_, msg.id_,"*⋄︙تم الغاء الاذاعه*") 
database:del(bot_id.."Tyler:Tyler:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false  
end 
...
if database:get(bot_id.."Tyler:Tyler:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ⋄" then   
send(msg.chat_id_, msg.id_,"*⋄︙تم الغاء الاذاعه*") 
database:del(bot_id.."Tyler:Tyler:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false  
end 
if msg.forward_info_ then 
local list = database:smembers(bot_id.."Tyler:UsersBot")   
...
local Tyler_Msg = database:sismember(bot_id.."Tyler:List:Filter:text"..msg.chat_id_,text) 
if Tyler_Msg then    
...
if msg.content_.ID == 'MessageAnimation' and not Vips(msg) then      
local geAni = database:sismember(bot_id.."Tyler:List:Filter:Animation"..msg.chat_id_,msg.content_.animation_.animation_.persistent_id_) 
if geAni then        
...
if msg.content_.ID == 'MessageSticker' and not Vips(msg) then      
local ker = database:sismember(bot_id.."Tyler:List:Filter:Sticker"..msg.chat_id_,msg.content_.sticker_.sticker_.persistent_id_) 
if ker then        
...
if msg.content_.ID == 'MessagePhoto' and not Vips(msg) then      
local phh = database:sismember(bot_id.."Tyler:List:Filter:Photo"..msg.chat_id_,msg.content_.photo_.sizes_[1].photo_.persistent_id_) 
if phh then        
...
if database:get(bot_id.."Tyler:Set:Name:Bot"..msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ⋄" then   
send(msg.chat_id_, msg.id_,"*⋄︙ تم الغاء حفظ اسم البوت*") 
database:del(bot_id.."Tyler:Set:Name:Bot"..msg.sender_user_id_) 
return false  
end 
database:del(bot_id.."Tyler:Set:Name:Bot"..msg.sender_user_id_) 
database:set(bot_id.."Tyler:Name:Bot",text) 
send(msg.chat_id_, msg.id_, "*⋄︙ تم حفظ اسم البوت*")  
return false
end 
if text and database:get(bot_id.."Tyler:Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
database:set(bot_id.."Tyler:Set:Cmd:Group:New"..msg.chat_id_,text)
send(msg.chat_id_, msg.id_,"*⋄︙ارسل الامر الجديد*")  
database:del(bot_id.."Tyler:Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
database:set(bot_id.."Tyler:Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_,"true1") 
return false
end
if text and database:get(bot_id.."Tyler:Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_) == "true1" then
local NewCmd = database:get(bot_id.."Tyler:Set:Cmd:Group:New"..msg.chat_id_)
database:set(bot_id.."Tyler:Set:Cmd:Group:New1"..msg.chat_id_..":"..text,NewCmd)
database:sadd(bot_id.."Tyler:List:Cmd:Group:New"..msg.chat_id_,text)
send(msg.chat_id_, msg.id_,"*⋄︙تم حفظ الامر*")  
database:del(bot_id.."Tyler:Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
--------------------------------------------------------------------------------------------------------------
...
{{text = 'مطور السورس', url="t.me/XXUUU"}},
}
...
database:set(bot_id.."Tyler:Lock:text"..msg.chat_id_,true) 
...
database:set(bot_id.."Tyler:Lock:AddMempar"..msg.chat_id_,"kick")  
...
database:set(bot_id.."Tyler:Lock:Join"..msg.chat_id_,"kick")  
...
database:set(bot_id.."Tyler:Lock:Bot:kick"..msg.chat_id_,"del")  
...
database:set(bot_id.."Tyler:Lock:Bot:kick"..msg.chat_id_,"kick")  
...
database:set(bot_id.."Tyler:Lock:tagservr"..msg.chat_id_,true)  
...
database:set(bot_id.."Tyler:lockpin"..msg.chat_id_, true) 
database:sadd(bot_id.."Tyler:Lock:pin",msg.chat_id_) 
tdcli_function ({ ID = "GetChannelFull",  channel_id_ = msg.chat_id_:gsub("-100","") }, function(arg,data)  database:set(bot_id.."Tyler:Pin:Id:Msg"..msg.chat_id_,data.pinned_message_id_)  end,nil)
...
database:set(bot_id.."Tyler:Lock:edit"..msg.chat_id_,true) 
...
database:set(bot_id.."Tyler:Lock:tagservrbot"..msg.chat_id_,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:set(bot_id..'Tyler:'..lock..msg.chat_id_,"del")    
end
...
database:del(bot_id.."Tyler:Lock:AddMempar"..msg.chat_id_)  
...
database:del(bot_id.."Tyler:Lock:text"..msg.chat_id_)  
...
database:del(bot_id.."Tyler:Lock:Join"..msg.chat_id_)  
...
database:del(bot_id.."Tyler:Lock:Bot:kick"..msg.chat_id_)  
...
database:del(bot_id.."Tyler:Lock:tagservr"..msg.chat_id_)  
...
database:del(bot_id.."Tyler:lockpin"..msg.chat_id_)  
database:srem(bot_id.."Tyler:Lock:pin",msg.chat_id_)
...
database:del(bot_id.."Tyler:Lock:edit"..msg.chat_id_) 
...
database:del(bot_id.."Tyler:Lock:tagservrbot"..msg.chat_id_)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:del(bot_id..'Tyler:'..lock..msg.chat_id_)    
end
...
database:del(bot_id.."Tyler:Lock:Link"..msg.chat_id_)  
...
database:del(bot_id.."Tyler:Lock:User:Name"..msg.chat_id_)  
...
database:del(bot_id.."Tyler:Lock:Animation"..msg.chat_id_)  
...
database:del(bot_id.."Tyler:Lock:Sticker"..msg.chat_id_)  
...
database:hset(bot_id.."Tyler:flooding:settings:"..msg.chat_id_ ,"flood","kick")  
...
database:hset(bot_id.."Tyler:flooding:settings:"..msg.chat_id_ ,"flood","del")  
...
database:hset(bot_id.."Tyler:flooding:settings:"..msg.chat_id_ ,"flood","keed")  
...
database:hset(bot_id.."Tyler:flooding:settings:"..msg.chat_id_ ,"flood","mute")  
...
database:hdel(bot_id.."Tyler:flooding:settings:"..msg.chat_id_ ,"flood")  
...
function Function_Tyler(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Tyler, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_Tyler, nil)
return false 
end
...
if text == ("الثانويين") and DevTyler(msg) then
local list = database:smembers(bot_id.."DEV:Sudo:T")
t = "\n*⋄︙قائمة مطورين الثانويين للبوت*\n*— — — — — — — — — — — — — —*\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."Tyler:User:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
else
t = t..""..k.."- (`"..v.."`)\n"
...
database:del(bot_id.."Tyler:Muted:User"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "*⋄︙ تم مسح قائمه المكتومين *")
end
if text == "مسح المحظورين" and Addictive(msg) and GetChannelMember(msg) then
database:del(bot_id.."Tyler:Ban:User"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "\n*⋄︙تم مسح المحظورين*")
end
if text == ("قائمه العام") and DevTyler(msg) then
local list = database:smembers(bot_id.."Tyler:GBan:User")
t = "\n*⋄︙قائمة المحظورين عام*\n*— — — — — — — — — — — — — —*\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."Tyler:User:Name" .. v)
if username then
...
if text == ("المطورين") and DevTyler(msg) then
local list = database:smembers(bot_id.."Tyler:Sudo:User")
t = "\n *⋄︙قائمة مطورين البوت* \n*— — — — — — — — — — — — — —*\n"
keyboard = {
...
local list = database:smembers(bot_id.."Tyler:Basic:Constructor"..msg.chat_id_)
...
local list = database:smembers(bot_id.."Tyler:Constructor"..msg.chat_id_)
t = "\n *⋄︙قائمة المنشئين* \n*— — — — — — — — — — — — — —*\n"
keyboard = {
...
local list = database:smembers(bot_id.."Tyler:Manager"..msg.chat_id_)
t = "\n⋄︙قائمة المدراء \n— — — — — — — — — — — — — — \n"
keyboard = {
...
local list = database:smembers(bot_id.."Tyler:Mod:User"..msg.chat_id_)
t = "\n *⋄︙قائمة الادمنيه* \n*— — — — — — — — — — — — — —*\n"
keyboard = {
...
local list = database:smembers(bot_id.."Tyler:Special:User"..msg.chat_id_)
t = "\n *⋄︙قائمة مميزين الكروب* \n*— — — — — — — — — — — — — —*\n"
keyboard = {
...
local list = database:smembers(bot_id.."Tyler:Muted:User"..msg.chat_id_)
t = "\n*⋄︙قائمة المكتومين*\n*— — — — — — — — — — — — — —*\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."Tyler:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."Tyler:Ban:User"..msg.chat_id_)
...
if text == ("كتم عام") and tonumber(msg.reply_to_message_id_) ~= 0 and DevTyler(msg) then
function Function_Tyler(extra, result, success)
...
database:sadd(bot_id.."Tyler:MuAn:User", result.sender_user_id_)
...
if text and text:match("^كتم عام @(.*)$")  and DevTyler(msg) then
...
database:sadd(bot_id.."Tyler:MuAn:User", result.id_)
...
if text and text:match("^كتم عام (%d+)$") and DevTyler(msg) then
local userid = text:match("^كتم عام (%d+)$")
if General_ban(userid, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, "\n*⋄︙عذرا لا تستطيع كتم عام ( "..Get_Rank(userid,msg.chat_id_).." )*")
return false
end
database:sadd(bot_id.."Tyler:MuAn:User", userid)
Reply_Status(msg,userid,"reply","*⋄︙تم حظره عام من المجموعات*")  
return false
end
if text == ("الغاء كتم العام") and tonumber(msg.reply_to_message_id_) ~= 0 and DevTyler(msg) then
function Function_Tyler(extra, result, success)
database:srem(bot_id.."Tyler:MuAn:User", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","*⋄︙تم الغاء كتم العام من المجموعات*")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Tyler, nil)
return false
end
if text and text:match("^الغاء كتم العام @(.*)$") and DevTyler(msg) then
local username = text:match("^الغاء كتم العام @(.*)$") 
function Function_Tyler(extra, result, success)
if result.id_ then
Reply_Status(msg,result.id_,"reply","*⋄︙تم الغاء كتم العام من المجموعات*")
database:srem(bot_id.."Tyler:MuAn:User", result.id_)
else
send(msg.chat_id_, msg.id_,"*⋄︙لا يوجد حساب بهاذا المعرف*")
end
end
...
if text and text:match("^الغاء كتم العام (%d+)$") and DevTyler(msg) then
local userid = text:match("^الغاء كتم العام (%d+)$")
database:srem(bot_id.."Tyler:MuAn:User", userid)
Reply_Status(msg,userid,"reply","*⋄︙تم الغاء كتم العام من المجموعات*")  
return false
end
if text == ("مسح قائمه كتم العام") and DevTyler(msg) then
database:del(bot_id.."Tyler:MuAn:User")
send(msg.chat_id_, msg.id_, "\n*⋄︙تم مسح قائمه العام*")
return false
end
if text == ("قائمه كتم العام") and DevTyler(msg) then
local list = database:smembers(bot_id.."Tyler:MuAn:User")
t = "\n*⋄︙قائمة المكتومين عام*\n*— — — — — — — — — — — — — — *\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."Tyler:User:Name" .. v)
if username then
...
if text == ("حظر عام") and tonumber(msg.reply_to_message_id_) ~= 0 and DevTyler(msg) then
function Function_Tyler(extra, result, success)
if General_ban(result.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, "\n*⋄︙عذرا لا تستطيع حظر عام ( "..Get_Rank(result.sender_user_id_,msg.chat_id_).." )*")
else
database:sadd(bot_id.."Tyler:GBan:User", result.sender_user_id_)
...
if text and text:match("^حظر عام @(.*)$")  and DevTyler(msg) then
...
database:sadd(bot_id.."Tyler:GBan:User", result.id_)
Reply_Status(msg,result.id_,"reply","*⋄︙تم حظره عام من المجموعات*")  
else
send(msg.chat_id_, msg.id_,"*⋄︙لا يوجد حساب بهاذا المعرف*")
end
...
if text and text:match("^حظر عام (%d+)$") and DevTyler(msg) then
local userid = text:match("^حظر عام (%d+)$")
if General_ban(userid, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, "\n*⋄︙عذرا لا تستطيع حظر عام ( "..Get_Rank(userid,msg.chat_id_).." )*")
return false
end
database:sadd(bot_id.."Tyler:GBan:User", userid)
Reply_Status(msg,userid,"reply","*⋄︙تم حظره عام من المجموعات*")  
return false
end
if text == ("الغاء العام") and tonumber(msg.reply_to_message_id_) ~= 0 and DevTyler(msg) then
function Function_Tyler(extra, result, success)
database:srem(bot_id.."Tyler:GBan:User", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","*⋄︙تم الغاء حظره عام من المجموعات*")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Tyler, nil)
return false
end
if text and text:match("^الغاء العام @(.*)$") and DevTyler(msg) then
local username = text:match("^الغاء العام @(.*)$") 
function Function_Tyler(extra, result, success)
if result.id_ then
Reply_Status(msg,result.id_,"reply","*⋄︙تم الغاء حظره عام من المجموعات*")  
database:srem(bot_id.."Tyler:GBan:User", result.id_)
else
send(msg.chat_id_, msg.id_,"*⋄︙لا يوجد حساب بهاذا المعرف*")
end
end
...
if text and text:match("^الغاء العام (%d+)$") and DevTyler(msg) then
local userid = text:match("^الغاء العام (%d+)$")
database:srem(bot_id.."Tyler:GBan:User", userid)
Reply_Status(msg,userid,"reply","*⋄︙تم الغاء حظره عام من المجموعات*")  
return false
end
if text == ("رفع مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and DevTyler(msg) then
function Function_Tyler(extra, result, success)
database:sadd(bot_id.."Tyler:Sudo:User", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","*⋄︙تم ترقيته مطور في البوت*")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Tyler, nil)
return false 
end
if text and text:match("^رفع مطور @(.*)$") and DevTyler(msg) then
...
database:sadd(bot_id.."Tyler:Sudo:User", result.id_)
...
if text and text:match("^رفع مطور (%d+)$") and DevTyler(msg) then
local userid = text:match("^رفع مطور (%d+)$")
database:sadd(bot_id.."Tyler:Sudo:User", userid)
Reply_Status(msg,userid,"reply","*⋄︙تم ترقيته مطور في البوت*")  
return false 
end
if text == ("تنزيل مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and DevTyler(msg) then
function Function_Tyler(extra, result, success)
database:srem(bot_id.."Tyler:Sudo:User", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","*⋄︙تم تنزيله من المطورين*")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Tyler, nil)
return false 
end
if text and text:match("^تنزيل مطور @(.*)$") and DevTyler(msg) then
local username = text:match("^تنزيل مطور @(.*)$")
function Function_Tyler(extra, result, success)
if result.id_ then
database:srem(bot_id.."Tyler:Sudo:User", result.id_)
...
if text and text:match("^تنزيل مطور (%d+)$") and DevTyler(msg) then
local userid = text:match("^تنزيل مطور (%d+)$")
database:srem(bot_id.."Tyler:Sudo:User", userid)
...
if database:get(bot_id.."Tyler:admin:Time"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك")
return false
end
database:setex(bot_id..'Tyler:admin:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
function Function_Tyler(extra, result, success)
database:sadd(bot_id.."Tyler:Basic:Constructor"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."Tyler:Basic:Constructor"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."Tyler:Basic:Constructor"..msg.chat_id_, userid)
...
function Function_Tyler(extra, result, success)
database:srem(bot_id.."Tyler:Basic:Constructor"..msg.chat_id_, result.sender_user_id_)
...
function Function_Tyler(extra, result, success)
if result.id_ then
database:srem(bot_id.."Tyler:Basic:Constructor"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."Tyler:Basic:Constructor"..msg.chat_id_, userid)
...
function Function_Tyler(extra, result, success)
database:sadd(bot_id.."Tyler:Constructor"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."Tyler:Constructor"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."Tyler:Constructor"..msg.chat_id_, userid)
...
function Function_Tyler(extra, result, success)
database:srem(bot_id.."Tyler:Constructor"..msg.chat_id_, result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","*⋄︙تم تنزيله من المنشئين*")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Tyler, nil)
end
...
function Function_Tyler(extra, result, success)
if result.id_ then
database:srem(bot_id.."Tyler:Constructor"..msg.chat_id_, result.id_)
Reply_Status(msg,result.id_,"reply","*⋄︙تم تنزيله من المنشئين*")  
else
send(msg.chat_id_, msg.id_,"*⋄︙لا يوجد حساب بهاذا المعرف*")
end
...
database:srem(bot_id.."Tyler:Constructor"..msg.chat_id_, userid)
Reply_Status(msg,userid,"reply","*⋄︙تم تنزيله من المنشئين*")  
end

if text == ("رفع مدير") and tonumber(msg.reply_to_message_id_) ~= 0 and Constructor(msg) and GetChannelMember(msg) then
function Function_Tyler(extra, result, success)
database:sadd(bot_id.."Tyler:Manager"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."Tyler:Manager"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."Tyler:Manager"..msg.chat_id_, userid)
...
function Function_Tyler(extra, result, success)
database:srem(bot_id.."Tyler:Manager"..msg.chat_id_, result.sender_user_id_)
...
function Function_Tyler(extra, result, success)
if result.id_ then
database:srem(bot_id.."Tyler:Manager"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."Tyler:Manager"..msg.chat_id_, userid)
...
function Function_Tyler(extra, result, success)
database:sadd(bot_id.."Tyler:Mod:User"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."Tyler:Mod:User"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."Tyler:Mod:User"..msg.chat_id_, userid)
...
function Function_Tyler(extra, result, success)
database:srem(bot_id.."Tyler:Mod:User"..msg.chat_id_, result.sender_user_id_)
...
function Function_Tyler(extra, result, success)
if result.id_ then
database:srem(bot_id.."Tyler:Mod:User"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."Tyler:Mod:User"..msg.chat_id_, userid)
...
local Added_Me = database:get(bot_id.."Tyler:Who:Added:Me"..msg.chat_id_..':'..msg.sender_user_id_)
if Added_Me then 
...
function Function_Tyler(extra, result, success)
database:srem(bot_id.."Tyler:Mote:User"..msg.chat_id_, result.sender_user_id_)
...
function Function_Tyler(extra, result, success)
database:sadd(bot_id.."Tyler:Mote:User"..msg.chat_id_, result.sender_user_id_)
...
database:del(bot_id.."Tyler:Mote:User"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "*⋄︙تم مسح  قائمة المطايه*")
end
if text == ("تاك للمطايه") and Owner(msg) then
local list = database:smembers(bot_id.."Tyler:Mote:User"..msg.chat_id_)
t = "\n *⋄︙قائمة مطايه الكروب* \n*— — — — — — — — — — — — — —*\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."Tyler:User:Name" .. v)
if username then
...
function Function_Tyler(extra, result, success)
database:srem(bot_id.."Tyler:Hata:User"..msg.chat_id_, result.sender_user_id_)
...
function Function_Tyler(extra, result, success)
database:sadd(bot_id.."Tyler:Hata:User"..msg.chat_id_, result.sender_user_id_)
...
database:del(bot_id.."Tyler:Hata:User"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "*⋄︙تم مسح  قائمة الحاته*")
end
if text == ("تاك للحاتات") and Owner(msg) then
local list = database:smembers(bot_id.."Tyler:Hata:User"..msg.chat_id_)
t = "\n *⋄︙قائمة حاتات الكروب* \n*— — — — — — — — — — — — — —*\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."Tyler:User:Name" .. v)
if username then
...
function Function_Tyler(extra, result, success)
database:srem(bot_id.."Tyler:Haat:User"..msg.chat_id_, result.sender_user_id_)
...
function Function_Tyler(extra, result, success)
database:sadd(bot_id.."Tyler:Haat:User"..msg.chat_id_, result.sender_user_id_)
...
database:del(bot_id.."Tyler:Haat:User"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "*⋄︙تم مسح  قائمة الحاتين*")
end
if text == ("تاك للحاتين") and Owner(msg) then
local list = database:smembers(bot_id.."Tyler:Haat:User"..msg.chat_id_)
...
function Function_Tyler(extra, result, success)
database:srem(bot_id.."Tyler:Sahl:User"..msg.chat_id_, result.sender_user_id_)
...
function Function_Tyler(extra, result, success)
database:sadd(bot_id.."Tyler:Sahl:User"..msg.chat_id_, result.sender_user_id_)
...
database:del(bot_id.."Tyler:Sahl:User"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "*⋄︙تم مسح  قائمة الصخوله*")
end
if text == ("تاك للصخوله") and Owner(msg) then
local list = database:smembers(bot_id.."Tyler:Sahl:User"..msg.chat_id_)
t = "\n *⋄︙قائمة صخوله الكروب* \n*— — — — — — — — — — — — — —*\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."Tyler:User:Name" .. v)
if username then
...
function Function_Tyler(extra, result, success)
database:srem(bot_id.."Tyler:Zahf:User"..msg.chat_id_, result.sender_user_id_)
...
function Function_Tyler(extra, result, success)
database:sadd(bot_id.."Tyler:Zahf:User"..msg.chat_id_, result.sender_user_id_)
...
database:del(bot_id.."Tyler:Zahf:User"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "*⋄︙تم مسح  قائمة الزواحف*")
end
if text == ("تاك للزواحف") and Owner(msg) then
local list = database:smembers(bot_id.."Tyler:Zahf:User"..msg.chat_id_)
...
function Function_Tyler(extra, result, success)
database:srem(bot_id.."Tyler:Zahfa:User"..msg.chat_id_, result.sender_user_id_)
...
function Function_Tyler(extra, result, success)
database:sadd(bot_id.."Tyler:Zahfa:User"..msg.chat_id_, result.sender_user_id_)
...
database:del(bot_id.."Tyler:Zahfa:User"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "*⋄︙تم مسح  قائمة الزاحفات*")
end
if text == ("تاك للزاحفات") and Owner(msg) then
local list = database:smembers(bot_id.."Tyler:Zahfa:User"..msg.chat_id_)
...
function Function_Tyler(extra, result, success)
database:srem(bot_id.."Tyler:Mrrte:User"..msg.chat_id_, result.sender_user_id_)
...
function Function_Tyler(extra, result, success)
database:sadd(bot_id.."Tyler:Mrrte:User"..msg.chat_id_, result.sender_user_id_)
...
database:del(bot_id.."Tyler:Mrrte:User"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "*⋄︙تم مسح  قائمة مرتي*")
end
if text == ("تاك للمرتي") and Owner(msg) then
local list = database:smembers(bot_id.."Tyler:Mrrte:User"..msg.chat_id_)
t = "\n *⋄︙قائمة مرتي الكروب* \n*— — — — — — — — — — — — — —*\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."Tyler:User:Name" .. v)
if username then
...
function Function_Tyler(extra, result, success)
database:srem(bot_id.."Tyler:Zoge:User"..msg.chat_id_, result.sender_user_id_)
...
function Function_Tyler(extra, result, success)
database:sadd(bot_id.."Tyler:Zoge:User"..msg.chat_id_, result.sender_user_id_)
...
database:del(bot_id.."Tyler:Zoge:User"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "*⋄︙تم مسح  قائمة زوجي*")
end
if text == ("تاك للزوجي") and Owner(msg) then
local list = database:smembers(bot_id.."Tyler:Zoge:User"..msg.chat_id_)
t = "\n *⋄︙قائمة زوجي الكروب* \n*— — — — — — — — — — — — — —*\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."Tyler:User:Name" .. v)
if username then
...
function Function_Tyler(extra, result, success)
database:srem(bot_id.."Tyler:lbee:User"..msg.chat_id_, result.sender_user_id_)
...
function Function_Tyler(extra, result, success)
database:sadd(bot_id.."Tyler:lbee:User"..msg.chat_id_, result.sender_user_id_)
...
database:del(bot_id.."Tyler:lbee:User"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "*⋄︙تم مسح  قائمة كلبي*")
end
if text == ("تاك للبكلبي") and Owner(msg) then
local list = database:smembers(bot_id.."Tyler:lbee:User"..msg.chat_id_)
t = "\n *⋄︙قائمة بكلبي الكروب* \n*— — — — — — — — — — — — — —*\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."Tyler:User:Name" .. v)
if username then
...
function Function_Tyler(extra, result, success)
database:srem(bot_id.."Tyler:Tajj:User"..msg.chat_id_, result.sender_user_id_)
...
function Function_Tyler(extra, result, success)
database:sadd(bot_id.."Tyler:Tajj:User"..msg.chat_id_, result.sender_user_id_)
...
database:del(bot_id.."Tyler:Tajj:User"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "*⋄︙تم مسح  قائمة تاج*")
end
if text == ("تاك للتاج") and Owner(msg) then
local list = database:smembers(bot_id.."Tyler:Tajj:User"..msg.chat_id_)
t = "\n *⋄︙قائمة تاج الكروب* \n*— — — — — — — — — — — — — —*\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."Tyler:User:Name" .. v)
if username then
...
function Function_Tyler(extra, result, success)
database:sadd(bot_id.."Tyler:Special:User"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."Tyler:Special:User"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."Tyler:Special:User"..msg.chat_id_, userid)
...
function Function_Tyler(extra, result, success)
database:srem(bot_id.."Tyler:Special:User"..msg.chat_id_, result.sender_user_id_)
...
function Function_Tyler(extra, result, success)
if result.id_ then
database:srem(bot_id.."Tyler:Special:User"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."Tyler:Special:User"..msg.chat_id_, userid)
...
if database:sismember(bot_id.."Tyler:Coomds"..msg.chat_id_,RTPA) then
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local Tylerrt = database:get(bot_id.."Tyler:Comd:New:rt:bot:"..RTPA..msg.chat_id_)
if Tylerrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"⋄︙العضو » ["..data.first_name_.."](t.me/"..(data.username_ or "D03DD")..")".."\n⋄︙تم رفعه "..RTPA.." هنا\n")
database:set(bot_id.."Tyler:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA) 
database:sadd(bot_id.."Tyler:Special:User"..msg.chat_id_,result.sender_user_id_)  
elseif Tylerrt == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"⋄︙العضو » ["..data.first_name_.."](t.me/"..(data.username_ or "D03DD")..")".."\n⋄︙تم رفعه "..RTPA.." هنا\n")
database:set(bot_id.."Tyler:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA)
database:sadd(bot_id.."Tyler:Mod:User"..msg.chat_id_,result.sender_user_id_)  
elseif Tylerrt == "مدير" and Constructor(msg) then
send(msg.chat_id_, msg.id_,"⋄︙العضو » ["..data.first_name_.."](t.me/"..(data.username_ or "D03DD")..")".."\n⋄︙تم رفعه "..RTPA.." هنا\n")
database:set(bot_id.."Tyler:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA)  
database:sadd(bot_id.."Tyler:Manager"..msg.chat_id_,result.sender_user_id_)  
elseif Tylerrt == "عضو" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"⋄︙العضو » ["..data.first_name_.."](t.me/"..(data.username_ or "D03DD")..")".."\n⋄︙تم رفعه "..RTPA.." هنا\n")
end
end,nil)   
end   
...
database:srem(bot_id.."Tyler:Special:User"..msg.chat_id_,result.sender_user_id_)  
database:del(bot_id.."Tyler:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif Tylerrt == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"*⋄︙العضو »* ["..data.first_name_.."](t.me/"..(data.username_ or "D03DD")..")".."\n*⋄︙تم تنزيله من "..RTPA.." هنا*\n")
database:srem(bot_id.."Tyler:Mod:User"..msg.chat_id_,result.sender_user_id_) 
database:del(bot_id.."Tyler:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
...
if database:sismember(bot_id.."Tyler:Coomds"..msg.chat_id_,text1[2]) then
function py_username(extra, result, success)   
if result.id_ then
local Tylerrt = database:get(bot_id.."Tyler:Comd:New:rt:bot:"..text1[2]..msg.chat_id_)
if Tylerrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"*⋄︙العضو »* ["..result.title_.."](t.me/"..(text1[3] or "D03DD")..")".."\n*⋄︙تم رفعه "..text1[2].." هنا*")
database:sadd(bot_id.."Tyler:Special:User"..msg.chat_id_,result.id_)  
database:set(bot_id.."Tyler:Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif Tylerrt == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"*⋄︙العضو »* ["..result.title_.."](t.me/"..(text1[3] or "D03DD")..")".."\n*⋄︙تم رفعه "..text1[2].." هنا*")
database:sadd(bot_id.."Tyler:Mod:User"..msg.chat_id_,result.id_)  
database:set(bot_id.."Tyler:Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
...
database:srem(bot_id.."Tyler:Special:User"..msg.chat_id_,result.id_)  
database:del(bot_id.."Tyler:Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif Tylerrt == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"*⋄︙العضو »* ["..result.title_.."](t.me/"..(text1[3] or "D03DD")..")".."\n*⋄︙تم تنزيله من "..text1[2].." هنا*")
database:srem(bot_id.."Tyler:Mod:User"..msg.chat_id_,result.id_)  
database:del(bot_id.."Tyler:Comd:New:rt:User:"..msg.chat_id_..result.id_)
...
function Function_Tyler(extra, result, success)
if result.sender_user_id_ == tonumber(1890819157) then
...
database:sadd(bot_id.."Tyler:Ban:User"..msg.chat_id_, result.sender_user_id_)
Kick_Group(result.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."Tyler:Ban:User"..msg.chat_id_, result.id_)
...
if userid == tonumber(1890819157) then
send(msg.chat_id_, msg.id_, "*⋄︙لا يمكن { حظر } Telegram Developer \n*")
return false
end
...
database:sadd(bot_id.."Tyler:Ban:User"..msg.chat_id_, userid)
...
database:srem(bot_id.."Tyler:Ban:User"..msg.chat_id_, result.sender_user_id_)
...
database:srem(bot_id.."Tyler:Ban:User"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."Tyler:Ban:User"..msg.chat_id_, userid)
...
database:sadd(bot_id.."Tyler:Muted:User"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."Tyler:Muted:User"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."Tyler:Muted:User"..msg.chat_id_, userid)
...
function Function_Tyler(extra, result, success)
database:srem(bot_id.."Tyler:Muted:User"..msg.chat_id_, result.sender_user_id_)
...
function Function_Tyler(extra, result, success)
if result.id_ then
database:srem(bot_id.."Tyler:Muted:User"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."Tyler:Muted:User"..msg.chat_id_, userid)
...
database:set(bot_id..'Tyler:Tyler:lock:Fshar'..msg.chat_id_,true) 
Reply_Status(msg,msg.sender_user_id_,"lock","*⋄︙تم قفـل الفارسيه*")  
end
if text and database:get(bot_id..'Tyler:lock:Fshar'..msg.chat_id_) and not Addictive(msg) then 
...
database:del(bot_id..'Tyler:Tyler:lock:Fshar'..msg.chat_id_) 
...
database:set(bot_id..'Tyler:lock:Fshar'..msg.chat_id_,true) 
Reply_Status(msg,msg.sender_user_id_,"lock","*⋄︙تم قفـل الفشار*")  
end
if text and database:get(bot_id..'Tyler:Tyler:lock:Fshar'..msg.chat_id_) and not Addictive(msg) then 
...
database:del(bot_id..'Tyler:lock:Fshar'..msg.chat_id_) 
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n*⋄︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'Tyler')..') '
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n*⋄︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'D03DD')..') '
status  = '\n*⋄︙الايدي »* '..result.sender_user_id_..'\n*⋄︙تم ضافه {'..timsh..'} كلقب له*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
if database:sismember(bot_id.."Tyler:Lock:pin",msg.chat_id_) and not Constructor(msg) then
...
database:set(bot_id.."Tyler:Pin:Id:Msg"..msg.chat_id_,msg.reply_to_message_id_)
...
database:del(bot_id.."Tyler:Pin:Id:Msg"..msg.chat_id_)
elseif data.code_ == 6 then
send(msg.chat_id_,msg.id_,"*⋄︙انا لست ادمن هنا يرجى ترقيتي ادمن ثم اعد المحاوله*")  
elseif data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_,"*⋄︙ليست لدي صلاحية التثبيت يرجى التحقق من الصلاحيات*")  
...
database:hset(bot_id.."Tyler:flooding:settings:"..msg.chat_id_ ,"floodmax" ,Num) 
...
database:hset(bot_id.."Tyler:flooding:settings:"..msg.chat_id_ ,"floodtime" ,Num) 
...
database:setex(bot_id.."Tyler:Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_,120,true) 
return false
end
end
if text == "الرابط" and GetChannelMember(msg) then
local status_Link = database:get(bot_id.."Tyler:Link_Group"..msg.chat_id_)
if not status_Link then
send(msg.chat_id_, msg.id_,"*⋄︙الرابط معطل اكتب تفعيل الرابط*") 
return false  
end
local link = database:get(bot_id.."Tyler:Private:Group:Link"..msg.chat_id_)            
if link then                              
...
database:set(bot_id.."Tyler:Link_Group"..msg.chat_id_,true) 
...
if Addictive(msg) then  
database:del(bot_id.."Tyler:Link_Group"..msg.chat_id_) 
...
database:del(bot_id.."Tyler:Private:Group:Link"..msg.chat_id_) 
return false      
end
return false  
end
...
database:set(bot_id.."Tyler:Change:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_,true) 
...
if Addictive(msg) then
database:setex(bot_id.."Tyler:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
...
if Addictive(msg) then
database:setex(bot_id.."Tyler:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
...
if database:get(bot_id.."Tyler:Get:Welcome:Group"..msg.chat_id_)   then 
Welcome = database:get(bot_id.."Tyler:Get:Welcome:Group"..msg.chat_id_)  
else 
...
local listtext = database:smembers(bot_id.."Tyler:List:Filter:text"..msg.chat_id_)  
for k,v in pairs(listtext) do  
database:srem(bot_id.."Tyler:List:Filter:text"..msg.chat_id_,v)  
end  
local listAnimation = database:smembers(bot_id.."Tyler:List:Filter:Animation"..msg.chat_id_)  
for k,v in pairs(listAnimation) do  
database:srem(bot_id.."Tyler:List:Filter:Animation"..msg.chat_id_,v)  
end  
local listSticker = database:smembers(bot_id.."Tyler:List:Filter:Sticker"..msg.chat_id_)  
for k,v in pairs(listSticker) do  
database:srem(bot_id.."Tyler:List:Filter:Sticker"..msg.chat_id_,v)  
end  
local listPhoto = database:smembers(bot_id.."Tyler:List:Filter:Photo"..msg.chat_id_)  
for k,v in pairs(listPhoto) do  
database:srem(bot_id.."Tyler:List:Filter:Photo"..msg.chat_id_,v)  
end  
...
database:set(bot_id.."Tyler:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."Tyler:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"*⋄︙تم منع الكلمه بنجاح*")  
database:del(bot_id.."Tyler:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:sadd(bot_id.."Tyler:List:Filter:text"..msg.chat_id_,text)  
return false 
end  
end
...
database:del(bot_id.."Tyler:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:sadd(bot_id.."Tyler:List:Filter:Animation"..msg.chat_id_,msg.content_.animation_.animation_.persistent_id_)  
return false 
end  
end
...
database:del(bot_id.."Tyler:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:sadd(bot_id.."Tyler:List:Filter:Sticker"..msg.chat_id_,msg.content_.sticker_.sticker_.persistent_id_)  
return false 
end  
end
...
database:del(bot_id.."Tyler:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:sadd(bot_id.."Tyler:List:Filter:Photo"..msg.chat_id_,msg.content_.photo_.sizes_[1].photo_.persistent_id_)  
return false 
end  
end
if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Addictive(msg) and GetChannelMember(msg) then
send(msg.chat_id_, msg.id_,"*⋄︙الان ارسل الشيء الذي تريد منعه*")
database:set(bot_id.."Tyler:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false 
end
if text then 
local test = database:get(bot_id.."Tyler:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test and test == "reppp" then   
send(msg.chat_id_, msg.id_,"*⋄︙تم الغاء منعها*")  
database:del(bot_id.."Tyler:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:srem(bot_id.."Tyler:List:Filter:text"..msg.chat_id_,text)  
return false
end  
end
if msg.content_.ID == 'MessageAnimation' then    
local onte = database:get(bot_id.."Tyler:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if onte and onte == "reppp" then   
send(msg.chat_id_, msg.id_,"*⋄︙تم الغاء منع المتحركه بنجاح*")  
database:del(bot_id.."Tyler:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:srem(bot_id.."Tyler:List:Filter:Animation"..msg.chat_id_,msg.content_.animation_.animation_.persistent_id_)  
return false
end  
end
if msg.content_.ID == 'MessageSticker' then    
local Stic = database:get(bot_id.."Tyler:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if Stic and Stic == "reppp" then   
send(msg.chat_id_, msg.id_,"*⋄︙تم الغاء منع الملصق بنجاح*")  
database:del(bot_id.."Tyler:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:srem(bot_id.."Tyler:List:Filter:Sticker"..msg.chat_id_,msg.content_.sticker_.sticker_.persistent_id_)  
return false
end  
end
if msg.content_.ID == 'MessagePhoto' then    
local hoto = database:get(bot_id.."Tyler:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if hoto and hoto == "reppp" then   
send(msg.chat_id_, msg.id_,"*⋄︙تم الغاء منع الصوره بنجاح*")  
database:del(bot_id.."Tyler:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:srem(bot_id.."Tyler:List:Filter:Photo"..msg.content_.photo_.sizes_[1].photo_.persistent_id_)  
return false
end  
end
...
if database:get(bot_id.."Tyler:Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" then 
send(msg.chat_id_, msg.id_, "*⋄︙تم الغاء حفظ القوانين*") 
database:del(bot_id.."Tyler:Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
return false  
end 
database:set(bot_id.."Tyler:Set:Rules:Group" .. msg.chat_id_,text) 
send(msg.chat_id_, msg.id_,"*⋄︙تم حفظ قوانين المجموعه*") 
database:del(bot_id.."Tyler:Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
end  
if text == "ضع قوانين" or text == "وضع قوانين" and GetChannelMember(msg) then
if Addictive(msg) then
database:setex(bot_id.."Tyler:Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
database:del(bot_id.."Tyler:Set:Rules:Group"..msg.chat_id_) 
end
end
if text == "القوانين" and GetChannelMember(msg) then
local Set_Rules = database:get(bot_id.."Tyler:Set:Rules:Group" .. msg.chat_id_)   
if Set_Rules then     
...
local list = database:smembers(bot_id.."Tyler:List:Cmd:Group:New"..msg.chat_id_.."")
t = "⋄︙قائمه الاوامر المضافه  \n— — — — — — — — — — — — — — \n"
for k,v in pairs(list) do
Cmds = database:get(bot_id.."Tyler:Set:Cmd:Group:New1"..msg.chat_id_..":"..v)
if Cmds then 
t = t..""..k.."- ("..v..") ~ {"..Cmds.."}\n"
else
t = t..""..k.."- ("..v..") \n"
...
local list = database:smembers(bot_id.."Tyler:List:Cmd:Group:New"..msg.chat_id_)
for k,v in pairs(list) do
database:del(bot_id.."Tyler:Set:Cmd:Group:New1"..msg.chat_id_..":"..v)
database:del(bot_id.."Tyler:List:Cmd:Group:New"..msg.chat_id_)
end
...
if text == "ترتيب الاوامر" and Constructor(msg) then
 database:set(bot_id.."Tyler:Set:Cmd:Group:New1"..msg.chat_id_..":ا","ايدي")
 database:sadd(bot_id.."Tyler:List:Cmd:Group:New"..msg.chat_id_,"ا")
 database:set(bot_id.."Tyler:Set:Cmd:Group:New1"..msg.chat_id_..":م","رفع مميز")
 database:sadd(bot_id.."Tyler:List:Cmd:Group:New"..msg.chat_id_,"م")
 database:set(bot_id.."Tyler:Set:Cmd:Group:New1"..msg.chat_id_..":اد","رفع ادمن")
 database:sadd(bot_id.."Tyler:List:Cmd:Group:New"..msg.chat_id_,"اد")
 database:set(bot_id.."Tyler:Set:Cmd:Group:New1"..msg.chat_id_..":مد","رفع مدير")
 database:sadd(bot_id.."Tyler:List:Cmd:Group:New"..msg.chat_id_,"مد")
 database:set(bot_id.."Tyler:Set:Cmd:Group:New1"..msg.chat_id_..":من","رفع منشئ")
 database:sadd(bot_id.."Tyler:List:Cmd:Group:New"..msg.chat_id_,"من")
 database:set(bot_id.."Tyler:Set:Cmd:Group:New1"..msg.chat_id_..":اس","رفع منشئ اساسي")
 database:sadd(bot_id.."Tyler:List:Cmd:Group:New"..msg.chat_id_,"اس")
 database:set(bot_id.."Tyler:Set:Cmd:Group:New1"..msg.chat_id_..":تعط","تعطيل الايدي بالصوره")
 database:sadd(bot_id.."Tyler:List:Cmd:Group:New"..msg.chat_id_,"تعط")
 database:set(bot_id.."Tyler:Set:Cmd:Group:New1"..msg.chat_id_..":تفع","تفعيل الايدي بالصوره")
 database:sadd(bot_id.."Tyler:List:Cmd:Group:New"..msg.chat_id_,"تفع")
 database:set(bot_id.."Tyler:Set:Cmd:Group:New1"..msg.chat_id_..":تك","تنزيل الكل")
 database:sadd(bot_id.."Tyler:List:Cmd:Group:New"..msg.chat_id_,"تك")
 database:set(bot_id.."Tyler:Set:Cmd:Group:New1"..msg.chat_id_..":رد","اضف رد")
 database:sadd(bot_id.."Tyler:List:Cmd:Group:New"..msg.chat_id_,"رد")
 database:set(bot_id.."Tyler:Set:Cmd:Group:New1"..msg.chat_id_..":حذ","حذف رد")
 database:sadd(bot_id.."Tyler:List:Cmd:Group:New"..msg.chat_id_,"حذ")
 database:set(bot_id.."Tyler:Set:Cmd:Group:New1"..msg.chat_id_..":ت","تثبيت")
 database:sadd(bot_id.."Tyler:List:Cmd:Group:New"..msg.chat_id_,"ت")
 send(msg.chat_id_, msg.id_,"*⋄︙تم ترتيب الاوامر بالشكل التالي*\n*⋄︙ايدي - ا .*\n*⋄︙مميز - م .\n⋄︙ادمن - اد .*\n*⋄︙مدير - مد . \n⋄︙منشى - من .*\n*⋄︙المنشئ الاساسي - اس .*\n*⋄︙تعطيل الايدي بالصوره - تعط .*\n*⋄︙تفعيل الايدي بالصوره - تفع .*\n*⋄︙تنزيل الكل - تك .*\n*⋄︙اضف رد - رد .*\n*⋄︙حذف رد - حذ .*\n*⋄︙تثبيت - ت .*")
 end
if text == "اضف امر" and Constructor(msg) and GetChannelMember(msg) then
database:set(bot_id.."Tyler:Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
send(msg.chat_id_, msg.id_,"*⋄︙الان ارسل لي الامر القديم*")  
return false
end
if text == "حذف امر" or text == "مسح امر" and GetChannelMember(msg) then
if Constructor(msg) then
database:set(bot_id.."Tyler:Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
...
local list = database:smembers(bot_id.."Tyler:Coomds"..msg.chat_id_)
if #list == 0 then
...
for k,v in pairs(list) do
var = database:get(bot_id.."Tyler:Comd:New:rt:bot:"..v..msg.chat_id_)
if var then
t = t..""..k.."- "..v.." ~ ("..var..")\n"
else
t = t..""..k.."- "..v.."\n"
...
local list = database:smembers(bot_id.."Tyler:Coomds"..msg.chat_id_)
for k,v in pairs(list) do
database:del(bot_id.."Tyler:Comd:New:rt:bot:"..v..msg.chat_id_)
database:del(bot_id.."Tyler:Coomds"..msg.chat_id_)
end
...
database:set(bot_id.."Tyler:Comd:New:rt"..msg.chat_id_..msg.sender_user_id_,ComdNew)  
database:sadd(bot_id.."Tyler:Coomds"..msg.chat_id_,ComdNew)  
database:setex(bot_id.."Tyler:Comd:New"..msg.chat_id_..""..msg.sender_user_id_,200,true)  
...
database:del(bot_id.."Tyler:Comd:New:rt:bot:"..ComdNew..msg.chat_id_)
send(msg.chat_id_, msg.id_, "⋄︙تم مسح الصلاحيه ") 
end
if database:get(bot_id.."Tyler:Comd:New"..msg.chat_id_..""..msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
send(msg.chat_id_, msg.id_,"*⋄︙تم الغاء الامر *") 
database:del(bot_id.."Tyler:Comd:New"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
if text == "مدير" then
...
local textn = database:get(bot_id.."Tyler:Comd:New:rt"..msg.chat_id_..msg.sender_user_id_)  
database:set(bot_id.."Tyler:Comd:New:rt:bot:"..textn..msg.chat_id_,text)
...
database:set(bot_id.."Tyler:Sudo:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"*⋄︙تم تغير رد المطور الى » "..Teext.."*")
end
if text and text:match("^تغير رد المنشئ الاساسي (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد المنشئ الاساسي (.*)$") 
database:set(bot_id.."Tyler:BasicConstructor:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"*⋄︙تم تغير رد المنشئ الاساسي الى » "..Teext.."*")
end
if text and text:match("^تغير رد المنشئ (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد المنشئ (.*)$") 
database:set(bot_id.."Tyler:Constructor:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"*⋄︙تم تغير رد المنشئ الى » "..Teext.."*")
end
if text and text:match("^تغير رد المدير (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد المدير (.*)$") 
database:set(bot_id.."Tyler:Manager:Rd"..msg.chat_id_,Teext) 
send(msg.chat_id_, msg.id_,"*⋄︙تم تغير رد المدير الى » "..Teext.."*")
end
if text and text:match("^تغير رد الادمن (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد الادمن (.*)$") 
database:set(bot_id.."Tyler:Mod:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"*⋄︙تم تغير رد الادمن الى » "..Teext.."*")
end
if text and text:match("^تغير رد المميز (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد المميز (.*)$") 
database:set(bot_id.."Tyler:Special:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"*⋄︙تم تغير رد المميز الى » "..Teext.."*")
end
if text and text:match("^تغير رد العضو (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد العضو (.*)$") 
database:set(bot_id.."Tyler:Memp:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"*⋄︙تم تغير رد العضو الى » "..Teext.."*")
end
if text == ("مسح الرتب") and BasicConstructor(msg) then
send(msg.chat_id_, msg.id_,"*⋄︙تم مسح رتب تغير*")
database:del(bot_id.."Tyler:Sudo:Rd"..msg.chat_id_)
database:del(bot_id.."Tyler:BasicConstructor:Rd"..msg.chat_id_)
database:del(bot_id.."Tyler:Constructor:Rd"..msg.chat_id_)
database:del(bot_id.."Tyler:Manager:Rd"..msg.chat_id_) 
database:del(bot_id.."Tyler:Mod:Rd"..msg.chat_id_)
database:del(bot_id.."Tyler:Special:Rd"..msg.chat_id_)
database:del(bot_id.."Tyler:Memp:Rd"..msg.chat_id_)
end
...
local list = database:smembers(bot_id.."Tyler:List:Manager"..msg.chat_id_.."")
for k,v in pairs(list) do
database:del(bot_id.."Tyler:Add:Rd:Manager:AudioCa"..v..msg.chat_id_)
database:del(bot_id.."Tyler:Add:Rd:Manager:FileCa"..v..msg.chat_id_)
database:del(bot_id.."Tyler:Add:Rd:Manager:VideoCa"..v..msg.chat_id_)
database:del(bot_id.."Tyler:Add:Rd:Manager:PhotoCa"..v..msg.chat_id_)
database:del(bot_id.."Tyler:Add:Rd:Manager:VicoCa"..v..msg.chat_id_)
database:del(bot_id.."Tyler:Add:Rd:Manager:GifCa"..v..msg.chat_id_)
database:del(bot_id.."Tyler:Add:Rd:Manager:Gif"..v..msg.chat_id_)   
database:del(bot_id.."Tyler:Add:Rd:Manager:Vico"..v..msg.chat_id_)   
database:del(bot_id.."Tyler:Add:Rd:Manager:Stekrs"..v..msg.chat_id_)     
database:del(bot_id.."Tyler:Add:Rd:Manager:Text"..v..msg.chat_id_)   
database:del(bot_id.."Tyler:Add:Rd:Manager:Photo"..v..msg.chat_id_)
database:del(bot_id.."Tyler:Add:Rd:Manager:Video"..v..msg.chat_id_)
database:del(bot_id.."Tyler:Add:Rd:Manager:File"..v..msg.chat_id_)
database:del(bot_id.."Tyler:Add:Rd:Manager:Audio"..v..msg.chat_id_)
database:del(bot_id.."Tyler:List:Manager"..msg.chat_id_)
end
...
for k,v in pairs(list) do
if database:get(bot_id.."Tyler:Add:Rd:Manager:Gif"..v..msg.chat_id_) then
db = "متحركه"
elseif database:get(bot_id.."Tyler:Add:Rd:Manager:Vico"..v..msg.chat_id_) then
db = "بصمه"
elseif database:get(bot_id.."Tyler:Add:Rd:Manager:Stekrs"..v..msg.chat_id_) then
db = "ملصق"
elseif database:get(bot_id.."Tyler:Add:Rd:Manager:Text"..v..msg.chat_id_) then
db = "رساله"
elseif database:get(bot_id.."Tyler:Add:Rd:Manager:Photo"..v..msg.chat_id_) then
db = "صوره"
elseif database:get(bot_id.."Tyler:Add:Rd:Manager:Video"..v..msg.chat_id_) then
db = "فيديو"
elseif database:get(bot_id.."Tyler:Add:Rd:Manager:File"..v..msg.chat_id_) then
db = "ملف"
elseif database:get(bot_id.."Tyler:Add:Rd:Manager:Audio"..v..msg.chat_id_) then
db = "اغنيه"
end
text = text..""..k..">> ("..v..") » {"..db.."}\n"
end
...
local test = database:get(bot_id.."Tyler:Text:Manager"..msg.sender_user_id_..":"..msg.chat_id_.."")
if database:get(bot_id.."Tyler:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:del(bot_id.."Tyler:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_)
if msg.content_.sticker_ then   
database:set(bot_id.."Tyler:Add:Rd:Manager:Stekrs"..test..msg.chat_id_, msg.content_.sticker_.sticker_.persistent_id_)  
end   
if msg.content_.voice_ then  
database:set(bot_id.."Tyler:Add:Rd:Manager:Vico"..test..msg.chat_id_, msg.content_.voice_.voice_.persistent_id_)  
if msg.content_.caption_ then
rtr = msg.content_.caption_
rtr = rtr:gsub('"',""):gsub('"',""):gsub("`",""):gsub("*","") 
database:set(bot_id.."Tyler:Add:Rd:Manager:VicoCa"..test..msg.chat_id_, rtr)  
end
end     
if msg.content_.animation_ then   
database:set(bot_id.."Tyler:Add:Rd:Manager:Gif"..test..msg.chat_id_, msg.content_.animation_.animation_.persistent_id_)  
if msg.content_.caption_ then
rtr = msg.content_.caption_
rtr = rtr:gsub('"',""):gsub('"',""):gsub("`",""):gsub("*","") 
database:set(bot_id.."Tyler:Add:Rd:Manager:GifCa"..test..msg.chat_id_, rtr)  
end
end  
if text then   
text = text:gsub('"',"") 
...
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."Tyler:Add:Rd:Manager:Text"..test..msg.chat_id_, text)  
end  
if msg.content_.audio_ then
database:set(bot_id.."Tyler:Add:Rd:Manager:Audio"..test..msg.chat_id_, msg.content_.audio_.audio_.persistent_id_)  
if msg.content_.caption_ then
rtr = msg.content_.caption_
rtr = rtr:gsub('"',""):gsub('"',""):gsub("`",""):gsub("*","") 
database:set(bot_id.."Tyler:Add:Rd:Manager:AudioCa"..test..msg.chat_id_, rtr)  
end
end  
if msg.content_.document_ then
database:set(bot_id.."Tyler:Add:Rd:Manager:File"..test..msg.chat_id_, msg.content_.document_.document_.persistent_id_)  
if msg.content_.caption_ then
rtr = msg.content_.caption_
rtr = rtr:gsub('"',""):gsub('"',""):gsub("`",""):gsub("*","") 
database:set(bot_id.."Tyler:Add:Rd:Manager:FileCa"..test..msg.chat_id_, rtr)  
end
end  
if msg.content_.video_ then
database:set(bot_id.."Tyler:Add:Rd:Manager:Video"..test..msg.chat_id_, msg.content_.video_.video_.persistent_id_)  
if msg.content_.caption_ then
rtr = msg.content_.caption_
rtr = rtr:gsub('"',""):gsub('"',""):gsub("`",""):gsub("*","") 
database:set(bot_id.."Tyler:Add:Rd:Manager:VideoCa"..test..msg.chat_id_, rtr)  
end
end  
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
...
database:set(bot_id.."Tyler:Add:Rd:Manager:Photo"..test..msg.chat_id_, photo_in_group)  
if msg.content_.caption_ then
rtr = msg.content_.caption_
rtr = rtr:gsub('"',""):gsub('"',""):gsub("`",""):gsub("*","") 
database:set(bot_id.."Tyler:Add:Rd:Manager:PhotoCa"..test..msg.chat_id_, rtr)  
end
end  
...
database:set(bot_id.."Tyler:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text == "حذف رد" and Owner(msg) and GetChannelMember(msg) then
send(msg.chat_id_, msg.id_,"*⋄︙ارسل الكلمه التي تريد حذفها*")
database:set(bot_id.."Tyler:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,"true2")
return false 
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."Tyler:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '*⋄︙الان ارسل الرد الذي تريد اضافته*')
database:set(bot_id.."Tyler:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,"true1")
database:set(bot_id.."Tyler:Text:Manager"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:del(bot_id.."Tyler:Add:Rd:Manager:Gif"..text..msg.chat_id_)   
database:del(bot_id.."Tyler:Add:Rd:Manager:Vico"..text..msg.chat_id_)   
database:del(bot_id.."Tyler:Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
database:del(bot_id.."Tyler:Add:Rd:Manager:Text"..text..msg.chat_id_)   
database:del(bot_id.."Tyler:Add:Rd:Manager:Photo"..text..msg.chat_id_)
database:del(bot_id.."Tyler:Add:Rd:Manager:Video"..text..msg.chat_id_)
database:del(bot_id.."Tyler:Add:Rd:Manager:File"..text..msg.chat_id_)
database:del(bot_id.."Tyler:Add:Rd:Manager:Audio"..text..msg.chat_id_)
database:sadd(bot_id.."Tyler:List:Manager"..msg.chat_id_.."", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."Tyler:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_.."") == "true2" then
send(msg.chat_id_, msg.id_,"*⋄︙تم ازالة الرد من قائمه الردود*")
database:del(bot_id.."Tyler:Add:Rd:Manager:AudioCa"..text..msg.chat_id_)
database:del(bot_id.."Tyler:Add:Rd:Manager:VicoCa"..text..msg.chat_id_)
database:del(bot_id.."Tyler:Add:Rd:Manager:PhotoCa"..text..msg.chat_id_)
database:del(bot_id.."Tyler:Add:Rd:Manager:FileCa"..text..msg.chat_id_)
database:del(bot_id.."Tyler:Add:Rd:Manager:GifCa"..text..msg.chat_id_)
database:del(bot_id.."Tyler:Add:Rd:Manager:Gif"..text..msg.chat_id_)   
database:del(bot_id.."Tyler:Add:Rd:Manager:Vico"..text..msg.chat_id_)   
database:del(bot_id.."Tyler:Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
database:del(bot_id.."Tyler:Add:Rd:Manager:Text"..text..msg.chat_id_)   
...
database:del(bot_id.."Tyler:Add:Rd:Manager:Audio"..text..msg.chat_id_)
database:del(bot_id.."Tyler:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."Tyler:List:Manager"..msg.chat_id_.."", text)
return false
end
end
if text and not database:get(bot_id.."Tyler:Reply:Manager"..msg.chat_id_) then
if not database:sismember(bot_id..'Tyler:Spam:Group'..msg.sender_user_id_,text) then
local anemi = database:get(bot_id.."Tyler:Add:Rd:Manager:Gif"..text..msg.chat_id_)   
local veico = database:get(bot_id.."Tyler:Add:Rd:Manager:Vico"..text..msg.chat_id_)   
local stekr = database:get(bot_id.."Tyler:Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
local Text = database:get(bot_id.."Tyler:Add:Rd:Manager:Text"..text..msg.chat_id_)   
local photo = database:get(bot_id.."Tyler:Add:Rd:Manager:Photo"..text..msg.chat_id_)  
local video = database:get(bot_id.."Tyler:Add:Rd:Manager:Video"..text..msg.chat_id_) 
local document = database:get(bot_id.."Tyler:Add:Rd:Manager:File"..text..msg.chat_id_)
local audio = database:get(bot_id.."Tyler:Add:Rd:Manager:Audio"..text..msg.chat_id_)
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(arg,data)
if Text then 
local NumMsg = database:get(bot_id..'Tyler:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = Get_Rank(msg.sender_user_id_,msg.chat_id_)
local message_edit = database:get(bot_id..'Tyler:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
...
send(msg.chat_id_, msg.id_,'['..Text..']')
database:sadd(bot_id.."Tyler:Spam:Group"..msg.sender_user_id_,text) 
end
if stekr then 
...
local Status_Gps = Get_Rank(msg.sender_user_id_,msg.chat_id_)
local message_edit = database:get(bot_id..'Tyler:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
local veicoCa = database:get(bot_id.."Tyler:Add:Rd:Manager:VicoCa"..text..msg.chat_id_)  or ""
...
local Status_Gps = Get_Rank(msg.sender_user_id_,msg.chat_id_)
local message_edit = database:get(bot_id..'Tyler:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
local videoCa = database:get(bot_id.."Tyler:Add:Rd:Manager:VideoCa"..text..msg.chat_id_) or ""
...
local Status_Gps = Get_Rank(msg.sender_user_id_,msg.chat_id_)
local message_edit = database:get(bot_id..'Tyler:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
local anemiCa = database:get(bot_id.."Tyler:Add:Rd:Manager:GifCa"..text..msg.chat_id_) or ""
...
local Status_Gps = Get_Rank(msg.sender_user_id_,msg.chat_id_)
local message_edit = database:get(bot_id..'Tyler:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
local documentCa = database:get(bot_id.."Tyler:Add:Rd:Manager:FileCa"..text..msg.chat_id_) or ""
...
local Status_Gps = Get_Rank(msg.sender_user_id_,msg.chat_id_)
local message_edit = database:get(bot_id..'Tyler:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
local audioCa = database:get(bot_id.."Tyler:Add:Rd:Manager:AudioCa"..text..msg.chat_id_)  or ""
...
local Status_Gps = Get_Rank(msg.sender_user_id_,msg.chat_id_)
local message_edit = database:get(bot_id..'Tyler:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
local photoCa = database:get(bot_id.."Tyler:Add:Rd:Manager:PhotoCa"..text..msg.chat_id_) or ""
...
database:del(bot_id.."Tyler:Reply:Manager"..msg.chat_id_)  
send(msg.chat_id_, msg.id_,"*⋄︙تم تفعيل ردود المدير*") 
end
if text == "تعطيل ردود المدير" and Owner(msg) then  
database:set(bot_id.."Tyler:Reply:Manager"..msg.chat_id_,true)  
...
function Function_Tyler(extra, result, success)
if DevTyler(result.sender_user_id_)  then
...
if DevTyler(msg.sender_user_id_)  then
database:srem(bot_id.."DEV:Sudo:T",result.sender_user_id_)
database:srem(bot_id.."Tyler:Sudo:User", result.sender_user_id_)
database:srem(bot_id.."Tyler:Basic:Constructor"..msg.chat_id_,result.sender_user_id_)
database:srem(bot_id.."Tyler:Constructor"..msg.chat_id_, result.sender_user_id_)
...
database:srem(bot_id.."Tyler:Mod:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."Tyler:Special:User"..msg.chat_id_, result.sender_user_id_)
elseif database:sismember(bot_id.."Tyler:Sudo:User",msg.sender_user_id_) then
database:srem(bot_id.."Tyler:Mod:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."Tyler:Special:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."Tyler:Manager"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."Tyler:Constructor"..msg.chat_id_, result.sender_user_id_)
...
database:srem(bot_id.."Tyler:Constructor"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."Tyler:Basic:Constructor"..msg.chat_id_,result.sender_user_id_)
elseif database:sismember(bot_id.."Tyler:Basic:Constructor"..msg.chat_id_, msg.sender_user_id_) then
database:srem(bot_id.."Tyler:Mod:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."Tyler:Special:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."Tyler:Manager"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."Tyler:Constructor"..msg.chat_id_, result.sender_user_id_)
elseif database:sismember(bot_id.."Tyler:Constructor"..msg.chat_id_, msg.sender_user_id_) then
database:srem(bot_id.."Tyler:Mod:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."Tyler:Special:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."Tyler:Manager"..msg.chat_id_, result.sender_user_id_)
elseif database:sismember(bot_id.."Tyler:Manager"..msg.chat_id_, msg.sender_user_id_) then
database:srem(bot_id.."Tyler:Mod:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."Tyler:Special:User"..msg.chat_id_, result.sender_user_id_)
end
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = text:match("^تنزيل الكل @(.*)$")}, Function_Tyler, nil)
end
...
for k, v in pairs(list) do
x = x + 1
if database:get(bot_id.."Tyler:User:Name"..v.user_id_) then
t = t.."*⋄︙"..x.."︙*[@"..database:get(bot_id.."Tyler:User:Name"..v.user_id_).."]\n"
end
end
send(msg.chat_id_,msg.id_,t)
end,nil)
...
Text = "[ ⋄︙قم بتأكيد عمليه الطرد](http://t.me/D03DD)"
keyboard = {} 
keyboard.inline_keyboard = {
...
function Function_Tyler(extra, result, success)
if result.id_ then
if database:sismember(bot_id.."Tyler:Muted:User"..msg.chat_id_,result.id_) then
Muted = "مكتوم"
else
Muted = "غير مكتوم"
end
if database:sismember(bot_id.."Tyler:Ban:User"..msg.chat_id_,result.id_) then
Ban = "محظور"
else
Ban = "غير محظور"
end
if database:sismember(bot_id.."Tyler:GBan:User",result.id_) then
GBan = "محظور عام"
else
GBan = "غير محظور عام"
end
...
function Function_Tyler(extra, result, success)
if database:sismember(bot_id.."Tyler:Muted:User"..msg.chat_id_,result.sender_user_id_) then
Muted = "مكتوم"
else
Muted = "غير مكتوم"
end
if database:sismember(bot_id.."Tyler:Ban:User"..msg.chat_id_,result.sender_user_id_) then
Ban = "محظور"
else
Ban = "غير محظور"
end
if database:sismember(bot_id.."Tyler:GBan:User",result.sender_user_id_) then
GBan = "محظور عام"
else
GBan = "غير محظور عام"
end
...
database:sadd(bot_id.."Tyler:Mod:User"..msg.chat_id_, admins[i].user_id_)
num2 = num2 + 1
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,b) 
if b.username_ == true then
end
if b.first_name_ == false then
database:srem(bot_id.."Tyler:Mod:User"..msg.chat_id_, admins[i].user_id_)
end
end,nil)   
else
database:srem(bot_id.."Tyler:Mod:User"..msg.chat_id_, admins[i].user_id_)
...
if text == "غادر" then 
if DevBot(msg) and not database:get(bot_id.."Tyler:Left:Bot"..msg.chat_id_) then 
tdcli_function ({ID = "ChangeChatMemberStatus",chat_id_=msg.chat_id_,user_id_=bot_id,status_={ID = "ChatMemberStatusLeft"},},function(e,g) end, nil) 
send(msg.chat_id_, msg.id_,"*⋄︙تم مغادرة المجموعه*") 
database:srem(bot_id.."Tyler:Chek:Groups",msg.chat_id_)  
end
return false  
end
...
database:srem(bot_id.."Tyler:Chek:Groups",GP_ID[2])  
return false 
end
end
if text == "تفعيل المغادره" and DevTyler(msg) then   
database:del(bot_id.."Tyler:Left:Bot"..msg.chat_id_)  
send(msg.chat_id_, msg.id_,"*⋄︙تم تفعيل مغادرة البوت*") 
return false 
end
if text == "تعطيل المغادره" and DevTyler(msg) then  
database:set(bot_id.."Tyler:Left:Bot"..msg.chat_id_,true)   
send(msg.chat_id_, msg.id_, "*⋄︙تم تعطيل مغادرة البوت*") 
return false 
end
if text == (database:get(bot_id.."Tyler:Name:Bot") or "تايلر") and GetChannelMember(msg) then
Namebot = (database:get(bot_id.."Tyler:Name:Bot") or "تايلر")
local namebot = {
'عمغي 🥺💕.',
...
if DevTyler(msg) then
database:setex(bot_id.."Tyler:Set:Name:Bot"..msg.sender_user_id_,300,true) 
...
if database:get(bot_id.."Tyler:Status:Bc") and not DevTyler(msg) then 
send(msg.chat_id_, msg.id_,"*⋄︙الاذاعه معطله من قبل المطور الاساسي*")
return false
end
database:setex(bot_id.."Tyler:Tyler:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
database:setex(bot_id.."Tyler:Tyler:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
database:setex(bot_id.."Tyler:Tyler:Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
database:setex(bot_id.."Tyler:Tyler:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
database:setex(bot_id.."Tyler:Tyler:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"*⋄︙ارسل لي التوجيه الان*") 
return false
end 

if text == "تفعيل الاذاعه" and DevTyler(msg) then  
database:del(bot_id.."Tyler:Status:Bc") 
send(msg.chat_id_, msg.id_,"\n*⋄︙تم تفعيل الاذاعه*") 
return false
end 
if text == "تعطيل الاذاعه" and DevTyler(msg) then  
database:set(bot_id.."Tyler:Status:Bc",true) 
send(msg.chat_id_, msg.id_,"\n*⋄︙تم تعطيل الاذاعه*") 
return false
end 

if text == "الاعدادات" and Addictive(msg) then    
if database:get(bot_id.."Tyler:lockpin"..msg.chat_id_) then    
lock_pin = "✓"
else 
lock_pin = "✘"    
end
if database:get(bot_id.."Tyler:Lock:tagservr"..msg.chat_id_) then    
lock_tagservr = "✓"
else 
lock_tagservr = "✘"    
end
if database:get(bot_id.."Tyler:Lock:text"..msg.chat_id_) then    
lock_text = "✓"
else 
lock_text = "✘"    
end
...
if database:get(bot_id.."Tyler:Lock:edit"..msg.chat_id_) then    
lock_edit = "✓"
else 
lock_edit = "✘"    
end
...
if database:hget(bot_id.."Tyler:flooding:settings:"..msg.chat_id_, "flood") == "kick" then     
flood = "بالطرد"     
elseif database:hget(bot_id.."Tyler:flooding:settings:"..msg.chat_id_,"flood") == "keed" then     
flood = "بالتقيد"     
elseif database:hget(bot_id.."Tyler:flooding:settings:"..msg.chat_id_,"flood") == "mute" then     
flood = "بالكتم"           
elseif database:hget(bot_id.."Tyler:flooding:settings:"..msg.chat_id_,"flood") == "del" then     
flood = "بالمسح"           
else     
flood = "✘"     
end
...
if database:get(bot_id.."Tyler:Lock:Link"..msg.chat_id_) == "del" then
lock_links = "✓"
elseif database:get(bot_id.."Tyler:Lock:Link"..msg.chat_id_) == "ked" then
lock_links = "بالتقيد"    
elseif database:get(bot_id.."Tyler:Lock:Link"..msg.chat_id_) == "ktm" then
lock_links = "بالكتم"    
elseif database:get(bot_id.."Tyler:Lock:Link"..msg.chat_id_) == "kick" then
lock_links = "بالطرد"    
else
lock_links = "✘"    
end
if database:get(bot_id.."Tyler:Lock:Cmd"..msg.chat_id_) == "del" then
lock_cmds = "✓"
elseif database:get(bot_id.."Tyler:Lock:Cmd"..msg.chat_id_) == "ked" then
lock_cmds = "بالتقيد"    
elseif database:get(bot_id.."Tyler:Lock:Cmd"..msg.chat_id_) == "ktm" then
lock_cmds = "بالكتم"   
elseif database:get(bot_id.."Tyler:Lock:Cmd"..msg.chat_id_) == "kick" then
lock_cmds = "بالطرد"    
else
lock_cmds = "✘"    
end
if database:get(bot_id.."Tyler:Lock:User:Name"..msg.chat_id_) == "del" then
lock_user = "✓"
elseif database:get(bot_id.."Tyler:Lock:User:Name"..msg.chat_id_) == "ked" then
lock_user = "بالتقيد"    
elseif database:get(bot_id.."Tyler:Lock:User:Name"..msg.chat_id_) == "ktm" then
lock_user = "بالكتم"    
elseif database:get(bot_id.."Tyler:Lock:User:Name"..msg.chat_id_) == "kick" then
lock_user = "بالطرد"    
else
lock_user = "✘"    
end
if database:get(bot_id.."Tyler:Lock:hashtak"..msg.chat_id_) == "del" then
lock_hash = "✓"
elseif database:get(bot_id.."Tyler:Lock:hashtak"..msg.chat_id_) == "ked" then 
lock_hash = "بالتقيد"    
elseif database:get(bot_id.."Tyler:Lock:hashtak"..msg.chat_id_) == "ktm" then 
lock_hash = "بالكتم"    
elseif database:get(bot_id.."Tyler:Lock:hashtak"..msg.chat_id_) == "kick" then 
lock_hash = "بالطرد"    
else
lock_hash = "✘"    
end
...
if database:get(bot_id.."Tyler:Lock:Bot:kick"..msg.chat_id_) == "del" then
lock_bots = "✓"
elseif database:get(bot_id.."Tyler:Lock:Bot:kick"..msg.chat_id_) == "ked" then
lock_bots = "بالتقيد"   
elseif database:get(bot_id.."Tyler:Lock:Bot:kick"..msg.chat_id_) == "kick" then
lock_bots = "بالطرد"    
else
lock_bots = "✘"    
end
...
if database:get(bot_id.."Tyler:Lock:Spam"..msg.chat_id_) == "del" then    
lock_spam = "✓"
elseif database:get(bot_id.."Tyler:Lock:Spam"..msg.chat_id_) == "ked" then 
lock_spam = "بالتقيد"    
elseif database:get(bot_id.."Tyler:Lock:Spam"..msg.chat_id_) == "ktm" then 
lock_spam = "بالكتم"    
elseif database:get(bot_id.."Tyler:Lock:Spam"..msg.chat_id_) == "kick" then 
lock_spam = "بالطرد"    
else
lock_spam = "✘"    
end        
if not database:get(bot_id.."Tyler:Reply:Manager"..msg.chat_id_) then
rdmder = "✓"
else
rdmder = "✘"
end
if not database:get(bot_id.."Tyler:Reply:Sudo"..msg.chat_id_) then
rdsudo = "✓"
else
rdsudo = "✘"
end
if not database:get(bot_id.."Tyler:Lock:ID:Bot"..msg.chat_id_)  then
idgp = "✓"
else
idgp = "✘"
end
if not database:get(bot_id.."Tyler:Lock:ID:Bot:Photo"..msg.chat_id_) then
idph = "✓"
else
idph = "✘"
end
if not database:get(bot_id.."Tyler:Lock:kick"..msg.chat_id_)  then
setadd = "✓"
else
setadd = "✘"
end
if not database:get(bot_id.."Tyler:Lock:Add:Bot"..msg.chat_id_)  then
banm = "✓"
else
banm = "✘"
end
if not database:get(bot_id.."Tyler:Kick:Me"..msg.chat_id_) then
kickme = "✓"
else
kickme = "✘"
end
Num_Flood = database:hget(bot_id.."Tyler:flooding:settings:"..msg.chat_id_,"floodmax") or 0
local text = 
"*\n⋄︙ااعدادات المجموعه "..
"\n— — — — — — — — — — — — — — "..
"\n⋄︙علامة ال {✓} تعني مفعل"..
...
database:set(bot_id.."Tyler:Klesh:Id:Bot"..msg.chat_id_,Text_Rand)
...
database:set(bot_id..'Tyler:Lock:ID:Bot:Photo'..msg.chat_id_,true) 
send(msg.chat_id_, msg.id_,'*⋄︙تم تعطيل الايدي بالصوره*') 
end
if text == 'تعين الايدي' and Owner(msg) and GetChannelMember(msg) then
database:setex(bot_id.."Tyler:Set:Id:Gp"..msg.chat_id_..""..msg.sender_user_id_,240,true)  
local Text= [[
⋄︙ ارسل الان النص
⋄︙ يمكنك اضافه :
...
if Owner(msg) then
database:del(bot_id.."Tyler:Klesh:Id:Bot"..msg.chat_id_)
send(msg.chat_id_, msg.id_, '*⋄︙تم ازالة كليشة الايدي*')
end
return false  
end 
if database:get(bot_id.."Tyler:Set:Id:Gp"..msg.chat_id_..""..msg.sender_user_id_) then 
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_,"*⋄︙تم الغاء تعين الايدي*") 
database:del(bot_id.."Tyler:Set:Id:Gp"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
database:del(bot_id.."Tyler:Set:Id:Gp"..msg.chat_id_..""..msg.sender_user_id_) 
database:set(bot_id.."Tyler:Klesh:Id:Bot"..msg.chat_id_,text:match("(.*)"))
send(msg.chat_id_, msg.id_,'*⋄︙تم تعين الايدي*')    
end
if text == 'ايدي' and tonumber(msg.reply_to_message_id_) == 0 and not database:get(bot_id..'Tyler:Lock:ID:Bot'..msg.chat_id_) and GetChannelMember(msg) then
if not database:sismember(bot_id..'Tyler:Spam:Group'..msg.sender_user_id_,text) then
database:sadd(bot_id.."Tyler:Spam:Group"..msg.sender_user_id_,text) 
...
local Add_Mem = database:get(bot_id.."Tyler:Add:Memp"..msg.chat_id_..":"..msg.sender_user_id_) or 0
...
local get_id = database:get(bot_id.."Tyler:Klesh:Id:Bot"..msg.chat_id_)
if not database:get(bot_id..'Tyler:Lock:ID:Bot:Photo'..msg.chat_id_) then
...
if not database:get(bot_id..'Tyler:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then           
...
database:setex(bot_id..'Tyler:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end
end
...
local Id = data.id_
local NumMsg = database:get(bot_id..'Tyler:messageUser'..msg.chat_id_..':'..data.id_) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = Get_Rank(Id,msg.chat_id_)
local message_edit = database:get(bot_id..'Tyler:message_edit'..msg.chat_id_..data.id_) or 0
local Num_Games = database:get(bot_id..'NUM:GAMES'..msg.chat_id_..data.id_) or 0
local Add_Mem = database:get(bot_id.."Tyler:Add:Memp"..msg.chat_id_..":"..data.id_) or 0
...
if text and text:match("^ايدي @(.*)$")  and not database:get(bot_id..'Tyler:Lock:ID:Bot'..msg.chat_id_) and GetChannelMember(msg) then
...
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'D03DD')..')'
...
database:del(bot_id..'Tyler:messageUser'..msg.chat_id_..':'..result.sender_user_id_) 
database:incrby(bot_id..'Tyler:messageUser'..msg.chat_id_..':'..result.sender_user_id_,Num)  
...
database:del(bot_id..'Tyler:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) 
database:incrby(bot_id..'Tyler:messageUser'..msg.chat_id_..':'..iduserr,numadded)  
...
if text == 'رسائلي' then
local nummsg = database:get(bot_id..'Tyler:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) or 1
...
local edit = database:get(bot_id..'Tyler:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
local Text = '*⋄︙عدد التعديلات هنا ~* '..edit..''
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
database:del(bot_id..'Tyler:message_edit'..msg.chat_id_..msg.sender_user_id_)
send(msg.chat_id_, msg.id_, '*⋄︙تم مسح جميع تعديلاتك*') 
end
if text == 'جهاتي' then
local addmem = database:get(bot_id.."Tyler:Add:Memp"..msg.chat_id_..":"..msg.sender_user_id_) or 0
local Text = '*⋄︙عدد جهاتك المضافه هنا ~* '..addmem..''
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'مسح جهاتي' then
database:del(bot_id..'Tyler:Add:Memp'..msg.chat_id_..':'..msg.sender_user_id_)
...
if text == "تنظيف المشتركين" and DevTyler(msg) then
local pv = database:smembers(bot_id..'Tyler:UsersBot')  
local sendok = 0
for i = 1, #pv do
...
database:srem(bot_id..'Tyler:UsersBot',pv[i])  
sendok = sendok + 1
end
if #pv == i then 
if sendok == 0 then
...
if text == "تنظيف الكروبات" and DevTyler(msg) then
local group = database:smembers(bot_id..'Tyler:Chek:Groups')  
local w = 0
local q = 0
for i = 1, #group do
...
database:srem(bot_id..'Tyler:Chek:Groups',group[i])  
w = w + 1
end
...
if text == 'تفعيل غنيلي' and DevTyler(msg) then   
...
if text == 'تعطيل غنيلي' and DevTyler(msg) then  
...
if text == ("تحديث السورس") and DevTyler(msg) then  
send(msg.chat_id_,msg.id_,'*⋄︙تم تحديث السورس الى الاصدار جديد*')
os.execute('rm -rf Tyler.lua')
os.execute('wget https://raw.githubusercontent.com/DMMARC/Tyler/main/Tyler.lua')
dofile('Tyler.lua')  
return false
end
if text == "راسلني" then
...
database:set(bot_id.."Tyler:zhrf_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الزخرفه" and Owner(msg) then
send(msg.chat_id_, msg.id_,'*⋄ تم تفعيل الزخرفه*')
database:set(bot_id.."Tyler:zhrf_Bots"..msg.chat_id_,"open")
end
if text and text:match("^زخرفه (.*)$") and database:get(bot_id.."Tyler:zhrf_Bots"..msg.chat_id_) == "open" then
...
ASAS = database:smembers(bot_id.."Tyler:Basic:Constructor"..v)
MNSH = database:smembers(bot_id.."Tyler:Constructor"..v)
MDER = database:smembers(bot_id.."Tyler:Manager"..v)
MOD = database:smembers(bot_id.."Tyler:Mod:User"..v)
link = database:get(bot_id.."Tyler:Link_Group"..v) or ''
if k == 1 then
t = t..'"'..v..'":{"Tyler":"'..NAME..'",'
else
t = t..',"'..v..'":{"Tyler":"'..NAME..'",'
...
if (msg.content_.sticker_)  and msg.reply_to_message_id_ == 0 and database:get(bot_id.."Tyler:Lock:Xn"..msg.chat_id_)=="del" then      
...
if (msg.content_.photo_) and msg.reply_to_message_id_ == 0 and database:get(bot_id.."Tyler:Lock:Xn"..msg.chat_id_)=="del" then
...
if text == 'تفعيل البوت الخدمي' and DevTyler(msg) then  
database:del(bot_id..'Tyler:Free:Add:Bots') 
send(msg.chat_id_, msg.id_,'*⋄︙تم تفعيل البوت الخدمي*') 
end
if text == 'تعطيل البوت الخدمي' and DevTyler(msg) then  
database:set(bot_id..'Tyler:Free:Add:Bots',true) 
send(msg.chat_id_, msg.id_,'*⋄︙تم تعطيل البوت الخدمي*') 
end
if text and text:match("^تعين عدد الاعضاء (%d+)$") and DevTyler(msg) then
local Num = text:match("تعين عدد الاعضاء (%d+)$") 
database:set(bot_id..'Tyler:Num:Add:Bot',Num) 
send(msg.chat_id_, msg.id_,'*⋄︙تم وضع عدد الاعضاء ~'..Num..' عضو*')
end
if text =='الاحصائيات' and DevBot(msg) then
local Groups = database:scard(bot_id..'Tyler:Chek:Groups')  
local Users = database:scard(bot_id..'Tyler:UsersBot')  
send(msg.chat_id_, msg.id_,'*⋄︙احصائيات البوت*\n\n*⋄︙عدد المجموعات ~ '..Groups..'*\n*⋄︙عدد المشتركين ~ '..Users..'*')
end
if text == 'جلب نسخه البوت' and DevTyler(msg) then
local list = database:smembers(bot_id..'Tyler:Chek:Groups')  
local t = '{"BOT_ID": '..bot_id..',"GP_BOT":{'  
for k,v in pairs(list) do   
NAME = 'Tyler Chat'
...
if text == 'المطور' then
local Text_Dev = database:get(bot_id..'Tyler:Text_Dev')
if Text_Dev then 
...
if text == 'الملفات' and DevTyler(msg) then
t = '*⋄︙جميع الملفات سورس تايلر*\n*— — — — — — — — — — — — — —*\n'
i = 0
for v in io.popen('ls Tyler_Files'):lines() do
if v:match(".lua$") then
i = i + 1
...
if DevTyler(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/DMMARC/Files_Tyler_main/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n *⋄︙اهلا بك في متجر ملفات تايلر*\n*⋄︙ملفات السورس ↓*\n*— — — — — — — — — — — — — —*\n\n"
local TextE = "\n*— — — — — — — — — — — — — —*\n *⋄︙علامة تعني { ✓ } ملف مفعل*\n *⋄︙علامة تعني { ✘ } ملف معطل*\n *⋄︙قناة سورس تايلر ↓*\n".." *⋄︙*[اضغط هنا لدخول](t.me/D03DD) \n"
local NumFile = 0
for name,Info in pairs(res.plugins_) do
local Check_File_is_Found = io.open("Tyler_Files/"..name,"r")
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevTyler(msg) then
local name_t = {string.match(text, "^(تعطيل) (.*)(.lua)$")}
local file = name_t[2]..'.lua'
local file_bot = io.open("Tyler_Files/"..file,"r")
if file_bot then
io.close(file_bot)
...
local json_file, res = https.request("https://raw.githubusercontent.com/DMMARC/Files_Tyler/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr Tyler_Files/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('Tyler.lua')  
else
...
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevTyler(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/DMMARC/Files_Tyler/main/File_Bot/"..file)
if res == 200 then
local chek = io.open("Tyler_Files/"..file,'w+')
...
if text == "مسح جميع الملفات" and DevTyler(msg) then
os.execute("rm -fr Tyler_Files/*")
send(msg.chat_id_,msg.id_,"*⋄︙تم حذف جميع الملفات*")
return false
end
if text == 'نقل الاحصائيات' and DevTyler(msg) then
local Users = database:smembers('Tyler:'..bot_id.."userss")
local Groups = database:smembers('Tyler:'..bot_id..'groups') 
for i = 1, #Groups do
database:sadd(bot_id..'Tyler:Chek:Groups',Groups[i])  
end
for i = 1, #Users do
database:sadd(bot_id..'Tyler:UsersBot',Users[i])  
end
send(msg.chat_id_, msg.id_,'*⋄︙تم نقل : '..#Groups..' كروب*\n*⋄︙تم نقل : '..#Users..' مشترك*\n*⋄︙من التحديث القديم الى التحديث الجديد*')
end
if text == 'حذف كليشه المطور' and DevTyler(msg) then
database:del(bot_id..'Tyler:Text_Dev')
send(msg.chat_id_, msg.id_,'*⋄︙تم حذف كليشه المطور*')
end
if text == 'وضع كليشه المطور' and DevTyler(msg) then
database:set(bot_id..'Tyler:Set:Text_Dev'..msg.chat_id_,true)
send(msg.chat_id_,msg.id_,'*⋄︙ارسل الكليشه الان*')
return false
end
if text and database:get(bot_id..'Tyler:Set:Text_Dev'..msg.chat_id_) then
if text == 'الغاء' then 
database:del(bot_id..'Tyler:Set:Text_Dev'..msg.chat_id_)
send(msg.chat_id_,msg.id_,'*⋄︙تم الغاء حفظ كليشة المطور*')
return false
end
database:set(bot_id..'Tyler:Text_Dev',text)
database:del(bot_id..'Tyler:Set:Text_Dev'..msg.chat_id_)
send(msg.chat_id_,msg.id_,'*⋄︙تم حفظ كليشة المطور*')
return false
end
if text == 'رفع نسخه البوت' and DevTyler(msg) then   
if tonumber(msg.reply_to_message_id_) > 0 then
function by_reply(extra, result, success)   
...
tdcli_function ({ ID = "GetChannelFull", channel_id_ = msg.chat_id_:gsub("-100","")}, function(arg,data)  
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Tyler:Num:Add:Bot') or 0) and not DevTyler(msg) then
send(msg.chat_id_, msg.id_,'⋄︙عدد اعضاء المجموعه اقل من *~ {'..(database:get(bot_id..'Tyler:Num:Add:Bot') or 0)..'* عضو')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if database:sismember(bot_id..'Tyler:Chek:Groups',msg.chat_id_) then
...
database:sadd(bot_id..'Tyler:Chek:Groups',msg.chat_id_)
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if not database:sismember(bot_id..'Tyler:Chek:Groups',msg.chat_id_) then
...
if text == 'تفعيل' and not DevBot(msg) and not database:get(bot_id..'Tyler:Free:Add:Bots') and GetChannelMember(msg) then
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,'⋄︙البوت ليس ادمن يرجى ترقيتي !') 
return false  
end
...
database:sadd(bot_id..'Tyler:Chek:Groups',msg.chat_id_)  
database:sadd(bot_id..'Tyler:Basic:Constructor'..msg.chat_id_, msg.sender_user_id_)
end
end
end
end,nil)   
...
if not database:get(bot_id..'Tyler:Start:Time'..msg.sender_user_id_) then
...
database:setex(bot_id..'Tyler:Start:Time'..msg.sender_user_id_,60,true)
return false
end
if text and text:match("^/start ph(.*)$") then
Sf = database:get(bot_id.."Tyler:Filter:msg")
local list = database:smembers(bot_id.."Tyler:List:Filter:Photo"..Sf)  
for k,v in pairs(list) do
if v then
inline = {
...
local list = database:smembers(bot_id.."Tyler:List:Filter:text"..sl)
...
local list = database:smembers(bot_id.."Tyler:List:Filter:Animation"..Sf)
for k,v in pairs(list) do
if v then
inline = {
...
local list = database:smembers(bot_id.."Tyler:List:Filter:Sticker"..Sf)
for k,v in pairs(list) do
if v then
inline = {
...
if not DevTyler(msg) and not database:sismember(bot_id..'BaN:In:User',msg.sender_user_id_) and not database:get(bot_id..'Texting:In:Bv') and not database:get(bot_id.."Tyler:Filter"..msg.sender_user_id_) then
...
if DevTyler(msg) and msg.reply_to_message_id_ ~= 0  then    
...
send(msg.chat_id_, msg.id_,' *⋄︙اصدار سورس تايلر* \n*⋄︙الاصدار »{ 2.8v}*')
end
if text == 'قناه تحديثات البوت ⋄'  then 
send(msg.chat_id_, msg.id_,' ⋄︙[تحديثات البوت](t.me/D03DD) \n⋄︙[قناه السورس](t.me/D03DD)')
end
...
t =t.."\n\nايدي المجموعه\n"..IdChat
send(Id_Sudo, 0,t)
database:srem(bot_id..'Tyler:Chek:Groups','-100'..data.channel_.id_)  
end,nil)
end
end
...
database:srem(bot_id..'Tyler:Ban:User'..Chat_id, OnID)
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = 'رجوع',callback_data=data.sender_user_id_.."Bbk"..OnID}},{{text = '- Source Tyler .', url="t.me/D03DD"}},}
...
if database:get(bot_id.."Tyler:Lock:kick"..Chat_id) and not Constructor(data) then
keyboard = {} 
keyboard.inline_keyboard = {{{text = 'رجوع',callback_data=data.sender_user_id_.."Bbk"..OnID}},{{text = '- Source Tyler .', url="t.me/D03DD"}},}
...
database:sadd(bot_id..'Tyler:Ban:User'..Chat_id, OnID)
keyboard = {} 
keyboard.inline_keyboard = {{{text = 'رجوع',callback_data=data.sender_user_id_.."Bbk"..OnID}},{{text = '- Source Tyler .', url="t.me/D03DD"}},}
...
if DevTyler(OnID) then
keyboard = {} 
keyboard.inline_keyboard = {{{text = 'رجوع',callback_data=data.sender_user_id_.."Bbk"..OnID}},{{text = '𝑇𝐸??𝐴𝑁𝐷 𝑇𝐸𝐴𝑀', url="t.me/D03DD"}},}
https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape("*⋄︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
return false 
end
if Rank_Checking(OnID, Chat_id) == true then
...
database:sadd(bot_id..'Tyler:Muted:User'..Chat_id, OnID)
keyboard = {} 
keyboard.inline_keyboard = {{{text = 'رجوع',callback_data=data.sender_user_id_.."Bbk"..OnID}},{{text = '- Source Tyler .', url="t.me/D03DD"}},}
...
if DevTyler(data) then
if database:sismember(bot_id.."Tyler:Basic:Constructor"..Chat_id,OnID) then
datainlineText = "لديه رتبه منشئ اساسي"
datainline = {
{{text = 'رجوع',callback_data=data.sender_user_id_.."Bbk"..OnID}},
{{text = '- Source Tyler .', url="t.me/D03DD"}},
}
elseif database:sismember(bot_id.."Tyler:Constructor"..Chat_id,OnID) then
...
elseif database:sismember(bot_id.."Tyler:Manager"..Chat_id,OnID) then
...
elseif database:sismember(bot_id.."Tyler:Mod:User"..Chat_id,OnID) then
...
elseif database:sismember(bot_id.."Tyler:Special:User"..Chat_id,OnID) then
...
if database:sismember(bot_id.."Tyler:Constructor"..Chat_id,OnID) then
...
database:sadd(bot_id.."Tyler:Basic:Constructor"..data.chat_id_, OnID)
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'رجوع',callback_data=data.sender_user_id_.."Bbk"..OnID}},
}
...
database:sadd(bot_id.."Tyler:Constructor"..data.chat_id_, OnID)
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'رجوع',callback_data=data.sender_user_id_.."Bbk"..OnID}},
}
...
database:sadd(bot_id.."Tyler:Manager"..data.chat_id_, OnID)
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'رجوع',callback_data=data.sender_user_id_.."Bbk"..OnID}},
}
...
database:sadd(bot_id.."Tyler:Mod:User"..data.chat_id_, OnID)
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'رجوع',callback_data=data.sender_user_id_.."Bbk"..OnID}},
}
...
database:sadd(bot_id.."Tyler:Special:User"..data.chat_id_, OnID)
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'رجوع',callback_data=data.sender_user_id_.."Bbk"..OnID}},
}
...
if database:sismember(bot_id.."Tyler:Manager"..Chat_id,OnID) then
Ma = "✅"
else
Ma = "✖"
end
if database:sismember(bot_id.."Tyler:Mod:User"..Chat_id,OnID) then
Mo = "✅"
else
Mo = "✖"
end
if database:sismember(bot_id.."Tyler:Special:User"..Chat_id,OnID) then
Sp = "✅"
else
Sp = "✖"
end
...
if database:sismember(bot_id.."Tyler:Basic:Constructor"..Chat_id,OnID) then
database:srem(bot_id.."Tyler:Basic:Constructor"..Chat_id,OnID)
...
if database:sismember(bot_id.."Tyler:Constructor"..Chat_id,OnID) then
database:srem(bot_id.."Tyler:Constructor"..Chat_id,OnID)
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape("تم تنزيله بنجاح ✅").."&show_alert=true")
Co = "✖"
else
...
if database:sismember(bot_id.."Tyler:Manager"..Chat_id,OnID) then
database:srem(bot_id.."Tyler:Manager"..Chat_id,OnID)
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape("تم تنزيله بنجاح ✅").."&show_alert=true")
Ma = "✖"
else
...
if database:sismember(bot_id.."Tyler:Mod:User"..Chat_id,OnID) then
database:srem(bot_id.."Tyler:Mod:User"..Chat_id,OnID)
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape("تم تنزيله بنجاح ✅").."&show_alert=true")
Mo = "✖"
else
...
if database:sismember(bot_id.."Tyler:Special:User"..Chat_id,OnID) then
database:srem(bot_id.."Tyler:Special:User"..Chat_id,OnID)
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape("تم تنزيله بنجاح ✅").."&show_alert=true")
Sp = "✖"
else
...
database:del(bot_id.."Tyler:Basic:Constructor"..Chat_id)
elseif OnID == "120" then
Vs = 'تم مسح المنشئين'
database:del(bot_id.."Tyler:Constructor"..Chat_id)
elseif OnID == "140" then
Vs = 'تم مسح المدراء'
database:del(bot_id.."Tyler:Manager"..Chat_id)
elseif OnID == "160" then
Vs = 'تم مسح الادمنيه'
database:del(bot_id.."Tyler:Mod:User"..Chat_id)
elseif OnID == "180" then
Vs = 'تم مسح المميزين'
database:del(bot_id.."Tyler:Special:User"..Chat_id)
end
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '-- Source Tyler .', url="t.me/D03DD"}},
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'Source Tyler',url='http://t.me/D03DD'}},
}
...
database:srem(bot_id.."Tyler:List:Filter:Animation"..idchci,animation)  
end
if DAata and DAata:match("^pito(.*)$") and Addictive(data) then  
local idchci = database:get(bot_id.."Tyler:Filter:msg")
...
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
send_inlin_key(Chat_id,Text,inline)
database:srem(bot_id.."Tyler:List:Filter:Photo"..idchci,photo)  
end
...
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
send_inlin_key(Chat_id,Text,inline)
database:srem(bot_id.."Tyler:List:Filter:Sticker"..idchci,Sticker)  
end
...
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
send_inlin_key(Chat_id,Text,inline)
local listSticker = database:smembers(bot_id.."Tyler:List:Filter:Sticker"..delallSticker)  
for k,v in pairs(listSticker) do  
database:srem(bot_id.."Tyler:List:Filter:Sticker"..delallSticker,v)  
end  
end
...
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
send_inlin_key(Chat_id,Text,inline)
local listAnimation = database:smembers(bot_id.."Tyler:List:Filter:Animation"..delallmation)  
for k,v in pairs(listAnimation) do  
database:srem(bot_id.."Tyler:List:Filter:Animation"..delallmation,v)  
end  
end
...
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
send_inlin_key(Chat_id,Text,inline)
local listPhoto = database:smembers(bot_id.."Tyler:List:Filter:Photo"..delallph)  
for k,v in pairs(listPhoto) do  
database:srem(bot_id.."Tyler:List:Filter:Photo"..delallph,v)  
end  
end
end
...
if text and not database:sismember(bot_id..'Tyler:Spam:Group'..msg.sender_user_id_,text) then
database:del(bot_id..'Tyler:Spam:Group'..msg.sender_user_id_) 
end
------------------------------------------------------------------------
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
database:set(bot_id..'Tyler:User:Name'..msg.sender_user_id_,data.username_)
end;end,nil)   
------------------------------------------------------------------------
if msg.content_.ID == "MessageChatAddMembers" then  
database:set(bot_id.."Tyler:Who:Added:Me"..msg.chat_id_..":"..msg.content_.members_[0].id_,msg.sender_user_id_)
local mem_id = msg.content_.members_  
local Bots = database:get(bot_id.."Tyler:Lock:Bot:kick"..msg.chat_id_) 
for i=0,#mem_id do  
...
------------------------------------------------------------------------
if text and database:get(bot_id.."Tyler:Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
local NewCmmd = database:get(bot_id.."Tyler:Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
if NewCmmd then
database:del(bot_id.."Tyler:Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
database:del(bot_id.."Tyler:Set:Cmd:Group:New"..msg.chat_id_)
database:srem(bot_id.."Tyler:List:Cmd:Group:New"..msg.chat_id_,text)
...
database:del(bot_id.."Tyler:Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
------------------------------------------------------------------------
if data.message_.content_.text_ then
local NewCmmd = database:get(bot_id.."Tyler:Set:Cmd:Group:New1"..msg.chat_id_..":"..data.message_.content_.text_)
if NewCmmd then
data.message_.content_.text_ = (NewCmmd or data.message_.content_.text_)
end
end
local Name_Bot = (database:get(bot_id.."Tyler:Name:Bot") or "تايلر")
if not database:get(bot_id.."Tyler:Fun_Bots"..msg.chat_id_) then
...
------------------------------------------------------------------------
Tyler_Started_Bot(msg,data)
Tyler_Files(msg)
elseif (data.ID == "UpdateMessageEdited") then
local msg = data
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.message_id_)},function(extra, result, success)
database:incr(bot_id..'Tyler:message_edit'..result.chat_id_..result.sender_user_id_)
local Text = result.content_.text_
if database:get(bot_id.."Tyler:Lock:edit"..msg.chat_id_) and not Text and not BasicConstructor(result) then
local list = database:smembers(bot_id.."Tyler:Basic:Constructor"..msg.chat_id_)
t = "⋄︙ المنشئين الاساسين تعالو مخرب \n— — — — — — — — — — — — — — \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."Tyler:User:Name" .. v)
...
if database:get(bot_id.."Tyler:Lock:Link"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end 
end
...
------------------------------------------------------------------------
if text and text:match("(.*)(@)(.*)") then
if database:get(bot_id.."Tyler:Lock:User:Name"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end  
end
...
------------------------------------------------------------------------
if text and text:match("(.*)(#)(.*)") then
if database:get(bot_id.."Tyler:Lock:hashtak"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end  
end 
...
------------------------------------------------------------------------
if text and text:match("/") then
if database:get(bot_id.."Tyler:Lock:Cmd"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end 
end 
...
------------------------------------------------------------------------
if text then
local Tyler_Msg = database:sismember(bot_id.."Tyler:List:Filter:text"..result.chat_id_,text) 
if Tyler_Msg then    
...
if msg.content_.ID == 'MessageAnimation' then    
local Animation_Msg = database:sismember(bot_id.."Tyler:List:Filter:Animation"..result.chat_id_,result.content_.animation_.animation_.persistent_id_) 
...
if msg.content_.ID == 'MessagePhoto' then    
local Photo_Msg = database:sismember(bot_id.."Tyler:List:Filter:Photo"..result.chat_id_,result.content_.photo_.sizes_[1].photo_.persistent_id_) 
if Photo_Msg then    
...
if msg.content_.ID == 'MessageSticker' then    
local Sticker_Msg = database:sismember(bot_id.."Tyler:List:Filter:Sticker"..result.chat_id_,result.content_.sticker_.sticker_.persistent_id_) 
if Sticker_Msg then    
...
local msg = data.message_
local text = msg.content_.text_
local Get_Msg_Pin = database:get(bot_id..'Tyler:Msg:Pin:Chat'..msg.chat_id_)
if Get_Msg_Pin ~= nil then
if text == Get_Msg_Pin then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,d) if d.ID == 'Ok' then;database:del(bot_id..'Tyler:Msg:Pin:Chat'..msg.chat_id_);end;end,nil)   
elseif (msg.content_.sticker_) then 
if Get_Msg_Pin == msg.content_.sticker_.sticker_.persistent_id_ then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,d) database:del(bot_id..'Tyler:Msg:Pin:Chat'..msg.chat_id_) end,nil)   
end
end
if (msg.content_.animation_) then 
...
database:srem(bot_id..'Tyler:Chek:Groups',v)  
end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusLeft" then
database:srem(bot_id..'Tyler:Chek:Groups',v)  
end
...
database:sadd(bot_id..'Tyler:Chek:Groups',v)  
end end,nil)
