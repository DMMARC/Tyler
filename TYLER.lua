...
local Text = {
'ليه غيرت معرفك شكله نشور معرفك في قنوات الفضايح😂😃',
"هههههه ليش غيرت معرفك لايكون ههدك حبيبك",
"ايش حصل لما غيرت معرفك قلي ايش سرك 😐🌝",
"غير معرفه خذه بسرعه بسرعه \n هاذه معرفه : @"..data.username_.."",
'ها ايش من جريمه مسوي  \n ايش غيرته ل @'..data.username_..' ',
'ها ي ولد اشتريت معرف جديد شكلك بكم اخذته', 
...
send(msg.chat_id_, msg.id_, "حذف كل صور الحلو هذا والله غبي😂🥺")
...
local Text = {
  "ليه غيرت صورتك من اي بروفيل اخذتها",
  "منور طلعت حلو في الصوره الجديده",
  "ي ولد غيرت صورتك مين قال لك انها مو حلوه😍😂",
  "هااه غيرت صورتك من وين سرقت الجديده اعترف 😹😹🌚",
...
------------------------------------------------------------------------ سـونـيـك
if text == 'تنزيل القرده' and Mod(msg) then
database:del(bot_id..'Motee:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' *✬︙تم تنزيل جميع القرده في القروب*')
end
if text == ("تاك للقرده") and Mod(msg) then
...
send(msg.chat_id_, msg.id_, ' *✬︙تم تنزيل جميع خيول القروب*')
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *✬︙اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'D03DD')..')'
local  statuss  = '\n*✬︙تم رفع خيل في القروب*\n*✬︙تعال ي خيل احطلك سرج وركبك نروح مشوار*'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' *✬︙تم تنزيل جميع الخرفان في القروب')
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *✬︙اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'D03DD')..')'
local  statuss  = '\n*✬︙تم رفع خروف في القروب*\n*✬︙اطلع برا ي ابو بعر قبل مانذبحك*'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
local TYLER_Msg = {
'شغلتنا '..Namebot..' و '..Namebot..'',
'هااا ☹️.',
'اشتبي؟',
'لبيه ياروح '..Namebot..'',
'مشغول شوي شوف احد تلعب معاه',
'عيون وقلب '..Namebot..' 💖'
}
...
send(msg.chat_id_, msg.id_,' *✬︙ما اقدر اصيح للقنوات ي غبي*') 
return false  
end
if result.type_.user_.type_.ID == "UserTypeBot" then
send(msg.chat_id_, msg.id_,' *✬︙ما اقدر اصيح للبوتات وش هل حاله😒*') 
return false  
end
if result and result.type_ and result.type_.channel_ and result.type_.channel_.is_supergroup_ == true then
send(msg.chat_id_, msg.id_,'*✬︙ما اقدر اصيح للقروبات بروح انتحر*') 
return false  
end
if result.id_ then
send(msg.chat_id_, msg.id_,' *✬︙تعال ي قلبي يصيحولك في القروب ['..username..']*') 
return false
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
...
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
Text = ' *✬︙الحلو الذي اضافك هو هذا 😄 »* '..Name
sendText(msg.chat_id_,Text,msg.id_/2097152/0.5,'md')
end,nil)
else
send(msg.chat_id_, msg.id_,' *✬︙انت دخلت عبر الرابط لاتكثر كلام*') 
end
end,nil)
else
...
send(msg.chat_id_, msg.id_," *✬︙ابشر تم اضافة {"..Num..'} من النقاط*')  
end
...
data,res = https.request('https://TYLER-api.ml/audios.php')
if res == 200 then
...
if text == "ايش رئيك بهذا" or text == "ايش رئيك بهذ" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"مادب بس بعض الاوقات يروح للبنات ??🥺"," هذا ولد يجنن 😶","خروف وما احبه 😾😹"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
if text == "ايش رئيك بهذي" or text == "ايش رئيك بهذه" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"دور على حلوين 🤕😹","مو حلوه ووصخه اتركها ☹️😾","حقيره ومتكبره 😶😂"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
...
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"امووووووووواححح????","عيب ما ابوس انا روح😌😹","خدك/ش نضيف 😂","البوسه بالف ريال حبي 🌝💋","خليه يجي لي وابوسه 🙊😻","كل شويه ابوسه خلاص طفشت 😏","ماابوسه والله هذا زاحف🦎","محح هذي ع الشفه"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
...
------------------------------------------------------------------------
local D03DD = database:get(bot_id.."TYLER1:Add:Filter:Rp2"..text..result.chat_id_)   
if D03DD then
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *✬︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n✬︙["..D03DD.."] \n") 
